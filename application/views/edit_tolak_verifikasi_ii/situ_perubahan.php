...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $edit->no_telp; ?>" type="text" class="form-control input-sm" name="no_telp" id="no_telp" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-2">
        <input value="<?php echo $edit->panjang_tempat_usaha ?>" type="number" class="form-control input-sm" name="panjang_tempat_usaha" id="panjang_tempat_usaha" />
    </div>
    <label for="inputEmail3" class="col-sm-1 control-label" style="text-align: center;">x</label>
    <div class="col-sm-2">
        <input value="<?php echo $edit->lebar_tempat_usaha ?>" type="number" class="form-control input-sm" name="lebar_tempat_usaha" id="lebar_tempat_usaha" />
    </div>
    ...
    <div class="col-sm-2">
        <input value="<?php echo ($edit->panjang_tempat_usaha * $edit->lebar_tempat_usaha) ?>" type="number" class="form-control input-sm" name="luas_tempat_usaha" id="luas_tempat_usaha" />
    </div>
...
<div class="form-group" style="margin-bottom: 0">
    ...
    <div class="col-sm-1" style="text-align: right">
        <label>
            <input <?php echo ($this->m_bidang_situ->nama_bidang_situ_exist($edit->nama_bidang_situ) == true) ? 'checked=""' : '' ?> type="radio" name="metode_input_bidang_situ" value="pilihan" class="metode_input_bidang_situ" /> Pilihan
        </label>
    </div>

    <div class="col-sm-1" style="text-align: right">
        <label>
            <input <?php echo ($this->m_bidang_situ->nama_bidang_situ_exist($edit->nama_bidang_situ) == false) ? 'checked=""' : '' ?> type="radio" name="metode_input_bidang_situ" value="manual" class="metode_input_bidang_situ" /> Manual
        </label>
    </div>
    ...
    <div class="col-sm-4">
        ...
        <select class="form-control input-sm" id="nama_bidang_situ_pilihan">
            ...
            <?php if($bidang_situ): foreach($bidang_situ as $r_bidang_situ): ?>
                <option 
                    <?php 
                        if($this->m_bidang_situ->nama_bidang_situ_exist($edit->nama_bidang_situ) == true){
                            echo ($edit->nama_bidang_situ == $r_bidang_situ->nama_bidang_situ) ? 'selected=""': '';
                        }
                    ?> 
        ...
        <!-- pilihan text manual -->
        <input value="<?php if($this->m_bidang_situ->nama_bidang_situ_exist($edit->nama_bidang_situ) == false){ echo $edit->nama_bidang_situ; } ?>" type="text" class="form-control input-sm" id="nama_bidang_situ_manual" />
    </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        <?php if($this->m_bidang_situ->nama_bidang_situ_exist($edit->nama_bidang_situ) == true): ?>
            console.
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $edit->klasifikasi; ?>" type="text" class="form-control input-sm" name="klasifikasi" id="klasifikasi" />
    </div>
</div>
