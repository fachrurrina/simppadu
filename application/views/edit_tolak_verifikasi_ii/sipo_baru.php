    ...
    <div class="col-sm-4">
        <select  name="id_kel_pemilik" id="id_kel_pemilik" class="form-control input-sm">
            ...
            <?php foreach ($kel as $r_kel): ?>
                <option <?php echo ($edit->id_kel_optik == $r_kel->id_kel) ? 'selected=""' : '' ?> value="<?php echo $r_kel->id_kel; ?>"><?php echo $r_kel->nm_kel; ?></option>
            <?php endforeach; ?>
        </select>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <input value="<?php echo $edit->no_surat_izin_kerja ?>" type="text" class="form-control input-sm" name="no_surat_izin_kerja" id="no_surat_izin_kerja" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input  value="<?php echo $edit->nama_optik; ?>" type="text" class="form-control input-sm" name="nama_optik" id="nama_optik" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6"><textarea  name="alamat_optik" id="alamat_optik" class="form-control input-sm"><?php echo $edit->alamat_optik ?></textarea></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select  name="id_kec_optik" id="id_kec_optik" class="form-control input-sm">
            <option value=""></option>
            <?php foreach ($kec as $r_kec): ?>
                <option <?php echo ($edit->id_kec_optik == $r_kec->id_kec) ? 'selected=""' : '' ?> value="<?php echo $r_kec->id_kec; ?>"><?php echo $r_kec->nm_kec; ?></option>
            <?php endforeach; ?>
        </select>
    </div>
</div>
