...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <select  class="form-control input-sm" name="merek_perusahaan" id="merek_perusahaan" >
            <option value=""></option>
            <option <?php echo ($edit->merek_perusahaan == "Milik Sendiri") ? 'selected=""' : ''; ?> value="Milik Sendiri">Milik Sendiri</option>
            <option <?php echo ($edit->merek_perusahaan == "Lisensi") ? 'selected=""' : ''; ?> value="Lisensi">Lisensi</option>
        </select>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input  value="<?php echo $edit->no_telp ?>" type="text" class="form-control input-sm" name="npwpd" id="npwpd" />
    </div>
</div>
<div class="form-group">
    ...
    <div class="col-sm-3"><input  value="<?php echo $edit->modal ?>" type="number" name="modal" id="modal" value="" class="form-control input-sm"></div>
    ...
    <div class="col-sm-1"><input  value="<?php echo get_status_modal_perusahaan($edit->modal) ?>"  type="text" class="form-control input-sm" name="ket_status_modal" id="ket_status_modal"></div>
</div>
    ...
    <div class="col-sm-6">
        <select  name="id_bidang_sib" id="id_bidang_sib" class="form-control input-sm">
            ...
            <?php if($bidang_sib): foreach($bidang_sib as $r_bidang_sib): ?>
                <option <?php echo ($edit->id_bidang_sib == $r_bidang_sib->id_bidang_sib) ? 'selected=""' : '' ?> value="<?php echo $r_bidang_sib->id_bidang_sib; ?>"><?php echo $r_bidang_sib->nama_bidang_sib; ?></option>
            <?php endforeach; endif; ?>
        </select>
...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <select  name="kelembagaan" id="kelembagaan" class="form-control input-sm">
            <option></option>
            <option <?php echo ($edit->kelembagaan == 'Supplier') ? 'selected=""' : '' ?> value="Supplier">Supplier</option>
