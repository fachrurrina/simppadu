...
<div class="form-group">
    ...
    <div class="col-sm-6"><input <?php // if($fo->siup_perpanjangan_status_perubahan == 0) { echo ''; } else { if($fo->siup_perpanjangan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->siup_perpanjangan_alasan_penerbitan == 'PL') { echo ''; } } ?> value="<?php echo $edit->nama_perusahaan; ?>" type="text" name="nama_perusahaan" id="nama_perusahaan" class="form-control input-sm"></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6"><input <?php // if($fo->siup_perpanjangan_status_perubahan == 0) { echo ''; } else { if($fo->siup_perpanjangan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->siup_perpanjangan_alasan_penerbitan == 'PL') { echo ''; } } ?> value="<?php echo $edit->nama_pemilik; ?>" type="text" name="nama_pemilik" id="nama_penanggung_jawab" class="form-control input-sm"></div>
</div>
<div class="form-group">
    <label for="" class="col-sm-2 control-label">No KTP Pemilik</label>
    <div class="col-sm-6"><input <?php // if($fo->siup_perpanjangan_status_perubahan == 0) { echo ''; } else { if($fo->siup_perpanjangan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->siup_perpanjangan_alasan_penerbitan == 'PL') { echo ''; } } ?> value="<?php echo $edit->no_ktp_pemilik ?>" type="text" name="no_ktp_pemilik" id="no_ktp_pemilik" class="form-control input-sm"></div>
</div>
<div class="form-group">
    <label for="" class="col-sm-2 control-label">Jabatan Pemilik</label>
    <div class="col-sm-6"><input <?php // if($fo->siup_perpanjangan_status_perubahan == 0) { echo ''; } else { if($fo->siup_perpanjangan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->siup_perpanjangan_alasan_penerbitan == 'PL') { echo ''; } } ?> value="<?php echo $edit->jabatan_pemilik ?>" type="text" name="jabatan_pemilik" id="jabatan_penanggung_jawab" class="form-control input-sm"></div>
</div>
<div class="form-group">
    <label for="" class="col-sm-2 control-label">Alamat Pemilik</label>
    <div class="col-sm-6"><textarea <?php // if($fo->siup_perpanjangan_status_perubahan == 0) { echo ''; } else { if($fo->siup_perpanjangan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->siup_perpanjangan_alasan_penerbitan == 'PL') { echo ''; } } ?> name="alamat_pemilik" id="alamat_pemilik" class="form-control input-sm"><?php echo $edit->alamat_pemilik ?></textarea></div>
</div>
...
<div class="form-group">
 ...
 <div class="form-group">
    ...
    <div class="col-sm-6"><input <?php // if($fo->siup_perpanjangan_status_perubahan == 0) { echo ''; } else { if($fo->siup_perpanjangan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->siup_perpanjangan_alasan_penerbitan == 'PL') { echo ''; } } ?> value="<?php echo $edit->no_telp ?>" type="text" name="no_telp" id="no_telp"  class="form-control input-sm"></div>
</div>
<div class="form-group">
    <label for="" class="col-sm-2 control-label">No Fax</label>
    <div class="col-sm-6"><input <?php // if($fo->siup_perpanjangan_status_perubahan == 0) { echo ''; } else { if($fo->siup_perpanjangan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->siup_perpanjangan_alasan_penerbitan == 'PL') { echo ''; } } ?> value="<?php echo $edit->no_fax ?>" type="text" name="no_fax" id="no_fax" class="form-control input-sm"></div>
</div>
<div class="form-group">
    ...
    <div class="col-sm-3"><input <?php // if($fo->siup_perpanjangan_status_perubahan == 0) { echo ''; } else { if($fo->siup_perpanjangan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->siup_perpanjangan_alasan_penerbitan == 'PL') { echo ''; } } ?> value="<?php echo $edit->modal_perusahaan ?>" type="number" name="modal_perusahaan" id="modal_perusahaan" value="" class="form-control input-sm"></div>
    ...
    <div class="col-sm-1"><input   value="<?php echo get_status_modal_perusahaan($edit->modal_perusahaan); ?>" type="text" class="form-control input-sm" name="ket_lalu" id="ket_lalu"></div>
    ...
    <div class="col-sm-1"><input <?php // if($fo->siup_perpanjangan_status_perubahan == 0) { echo ''; } else { if($fo->siup_perpanjangan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->siup_perpanjangan_alasan_penerbitan == 'PL') { echo ''; } } ?> value="<?php echo get_status_modal_perusahaan($edit->modal_perusahaan); ?>" type="text" class="form-control input-sm" name="ket" id="ket"></div>
    <?php endif; endif; ?>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-2"><input <?php // if($fo->siup_perpanjangan_status_perubahan == 0) { echo ''; } else { if($fo->siup_perpanjangan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->siup_perpanjangan_alasan_penerbitan == 'PL') { echo ''; } } ?> value="<?php echo $edit->tenaga_kerja_a ?>" type="number" name="tenaga_kerja_a" id="tenaga_kerja_a" class="form-control input-sm"></div>
...
<div class="form-group">
    ...
    <div class="col-sm-2"><input <?php // if($fo->siup_perpanjangan_status_perubahan == 0) { echo ''; } else { if($fo->siup_perpanjangan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->siup_perpanjangan_alasan_penerbitan == 'PL') { echo ''; } } ?> value="<?php echo $edit->tenaga_kerja_b ?>" type="number" name="tenaga_kerja_b" id="tenaga_kerja_b" class="form-control input-sm"></div>
...
<div class="form-group">
    ...
    <div class="col-sm-2"><input <?php // if($fo->siup_perpanjangan_status_perubahan == 0) { echo ''; } else { if($fo->siup_perpanjangan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->siup_perpanjangan_alasan_penerbitan == 'PL') { echo ''; } } ?> value="<?php echo $edit->tenaga_kerja_c ?>" type="number" name="tenaga_kerja_c" id="tenaga_kerja_c" class="form-control input-sm"></div>
...
<div class="form-group">
    ...
    <div class="col-sm-2"><input <?php // if($fo->siup_perpanjangan_status_perubahan == 0) { echo ''; } else { if($fo->siup_perpanjangan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->siup_perpanjangan_alasan_penerbitan == 'PL') { echo ''; } } ?> value="<?php echo $edit->tenaga_kerja_d ?>" type="number" name="tenaga_kerja_d" id="tenaga_kerja_d" class="form-control input-sm"></div>
...
<div class="form-group">
    ...
    <div class="col-sm-6"><textarea <?php // if($fo->siup_perpanjangan_status_perubahan == 0) { echo ''; } else { if($fo->siup_perpanjangan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->siup_perpanjangan_alasan_penerbitan == 'PL') { echo ''; } } ?> name="barang_jasa_dagangan_utama" id="barang_jasa_dagangan_utama" class="form-control input-sm"><?php echo $edit->barang_jasa_dagangan_utama ?></textarea></div>
</div>
