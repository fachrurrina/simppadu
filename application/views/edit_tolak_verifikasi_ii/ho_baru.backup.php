...
<div class="form-group">
    ...
    <div class="col-sm-7">
        <select class="form-control input-sm" name="id_bidang_ho" id="id_bidang_ho" >
            <option></option>
...
<div class="form-group">
    ...
    <div class="col-sm-6"><input value="<?php echo $edit->tanggal_surat_ket_usaha ?>" type="date" name="tanggal_surat_ket_usaha" id="tanggal_surat_ket_usaha" class="form-control input-sm"></div>
</div>
