...
<div class="form-group">
    ...
    <div class="col-sm-4"><input readonly="" value="<?php echo $edit->tanggal_daftar_ulang ?>" type="date" name="tanggal_daftar_ulang" id="tanggal_daftar_ulang" class="form-control input-sm"></div>
</div>
