...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input  value="<?php echo $edit->no_surat_dirjen_buk ?>" type="text" class="form-control input-sm" name="no_surat_dirjen_buk" id="no_surat_dirjen_buk" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input  value="<?php echo $edit->tanggal_surat_dirjen_buk ?>" type="date" class="form-control input-sm" name="tanggal_surat_dirjen_buk" id="tanggal_surat_dirjen_buk" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input  value="<?php echo $edit->klasifikasi_kelas_menkes ?>" type="text" class="form-control input-sm" name="klasifikasi_kelas_menkes" id="klasifikasi_kelas_menkes" />
    </div>
</div>
