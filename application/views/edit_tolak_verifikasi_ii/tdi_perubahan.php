...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input  value="<?php echo $edit->npwp ?>" type="text" class="form-control input-sm" name="npwp" id="npwp" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input  value="<?php echo $edit->nipik ?>" type="text" class="form-control input-sm" name="nipik" id="nipik" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <ul>
            <?php foreach(explode('|', $edit->id_kbli) as $id_kbli): ?>
...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <input  value="<?php echo $edit->komoditi_industri ?>" type="text" class="form-control input-sm" name="komoditi_industri" id="komoditi_industri" />
    </div>
</div>

<div class="form-group">
    <label for="" class="col-sm-2 control-label">Alamat Pabrik</label>
    <div class="col-sm-6"><textarea  name="alamat_pabrik" id="alamat_pabrik" class="form-control input-sm"><?php echo $edit->alamat_pabrik ?></textarea></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select  name="id_kec_pabrik" id="id_kec_pabrik" class="form-control input-sm">
            <option value=""></option>
            <?php foreach ($kec as $r_kec): ?>
                <option <?php echo ($edit->id_kec_pabrik == $r_kec->id_kec) ? 'selected=""' : ''; ?> value="<?php echo $r_kec->id_kec; ?>"><?php echo $r_kec->nm_kec; ?></option>
            <?php endforeach; ?>
        </select>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select  name="id_kel_pabrik" id="id_kel_pabrik" class="form-control input-sm">
            <option value=""></option>
            <?php foreach ($kel as $r_kel): ?>
                <option <?php echo ($edit->id_kel_pabrik == $r_kel->id_kel) ? 'selected=""' : ''; ?> value="<?php echo $r_kel->id_kel; ?>"><?php echo $r_kel->nm_kel; ?></option>
            <?php endforeach; ?>
        </select>
        <p class="help-block">Jika ada kecamatan atau gampong yang belum tersedia, silahkan hubungi administrator untuk menambahkan</p>
    </div>
...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <input  value="<?php echo $edit->mesin_utama ?>" type="text" class="form-control input-sm" name="mesin_utama" id="mesin_utama" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <input  value="<?php echo $edit->mesin_pembantu ?>" type="text" class="form-control input-sm" name="mesin_pembantu" id="mesin_pembantu" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <input  value="<?php echo $edit->tenaga_penggerak ?>" type="text" class="form-control input-sm" name="tenaga_penggerak" id="tenaga_penggerak" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input  value="<?php echo $edit->nilai_investasi ?>" type="number" class="form-control input-sm" name="nilai_investasi" id="nilai_investasi" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-2">
        <input  value="<?php echo $edit->kapasitas_produksi ?>" type="text" class="form-control input-sm" name="kapasitas_produksi" id="kapasitas_produksi" />
    </div>
</div>
