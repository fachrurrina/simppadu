...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <input value=<?php echo $edit->jenis_usaha ?>"" type="text" class="form-control input-sm" name="jenis_usaha" id="jenis_usaha" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $edit->jumlah_kendaraan ?>" type="number" class="form-control input-sm" name="jumlah_kendaraan" id="jumlah_kendaraan" />
    </div>
</div>
