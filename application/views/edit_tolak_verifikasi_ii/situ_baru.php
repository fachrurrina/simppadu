...
<div class="form-group">
    ...
    <div class="col-sm-1">
        <input step="any" value="<?php echo $edit->panjang_tempat_usaha ?>" type="number" class="form-control input-sm" name="panjang_tempat_usaha" id="panjang_tempat_usaha" />
    </div>
    <label for="inputEmail3" class="col-sm-1 control-label" style="text-align: center;">x</label>
    <div class="col-sm-1">
        <input step="any" value="<?php echo $edit->lebar_tempat_usaha ?>" type="number" class="form-control input-sm" name="lebar_tempat_usaha" id="lebar_tempat_usaha" />
    </div>
    ...
    <div class="col-sm-1">
        <input step="any" value="<?php echo ($edit->panjang_tempat_usaha * $edit->lebar_tempat_usaha); ?>" type="number" class="form-control input-sm" name="luas_tempat_usaha" id="luas_tempat_usaha" />
    </div>
...
<div class="form-group" style="margin-bottom: 0">
    ...
    <div class="col-sm-1" style="text-align: right">
        <label>
            <input <?php echo ($this->m_bidang_situ->nama_bidang_situ_exist($edit->nama_bidang_situ)) ? 'checked=""' : '' ?> type="radio" name="metode_input_bidang_situ" value="pilihan" class="metode_input_bidang_situ" /> Pilihan
        </label>
    </div>

    <div class="col-sm-1" style="text-align: right">
        <label>
            <input <?php echo ($this->m_bidang_situ->nama_bidang_situ_exist($edit->nama_bidang_situ)) ? '' : 'checked=""' ?> type="radio" name="metode_input_bidang_situ" value="manual" class="metode_input_bidang_situ" /> Manual
        </label>
    </div>
    ...
    <div class="col-sm-4">
        ...
        <select class="form-control input-sm" id="nama_bidang_situ_pilihan">
            ...
            <?php if($bidang_situ): foreach($bidang_situ as $r_bidang_situ): ?>
                <option <?php echo ($edit->nama_bidang_situ == $r_bidang_situ->nama_bidang_situ) ? 'selected=""' : '' ?> value="<?php echo $r_bidang_situ->nama_bidang_situ ?>"><?php echo $r_bidang_situ->nama_bidang_situ ?></option>
            <?php endforeach; endif; ?>
        </select>
        
        <!-- pilihan text manual -->
        <input value="<?php echo $edit->nama_bidang_situ ?>" type="text" class="form-control input-sm" id="nama_bidang_situ_manual" />
    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        // inputan manual secara default disembunyikan.
        <?php if($this->m_bidang_situ->nama_bidang_situ_exist($edit->nama_bidang_situ)): ?>
