...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $edit->tanggal_daftar ; ?>" readonly="" type="date" class="form-control input-sm" name="tanggal_daftar" id="tanggal_daftar" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6"><textarea  name="alamat_bangunan" id="alamat_bangunan" class="form-control input-sm"><?php echo $edit->alamat_bangunan ?></textarea></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select  name="id_kec_bangunan" id="id_kec_bangunan" class="form-control input-sm">
            <option value=""></option>
            <?php foreach ($kec as $r_kec): ?>
                <option <?php echo ($edit->id_kec_bangunan == $r_kec->id_kec) ? 'selected=""' : '' ?> value="<?php echo $r_kec->id_kec; ?>"><?php echo $r_kec->nm_kec; ?></option>
            <?php endforeach; ?>
        </select>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select  name="id_kel_bangunan" id="id_kel_bangunan" class="form-control input-sm">
            <option value=""></option>
            <?php foreach ($kel as $r_kel): ?>
                <option <?php echo ($edit->id_kel_bangunan == $r_kel->id_kel) ? 'selected=""' : '' ?> value="<?php echo $r_kel->id_kel; ?>"><?php echo $r_kel->nm_kel; ?></option>
            <?php endforeach; ?>
        </select>
        <p class="help-block">Jika ada kecamatan atau gampong yang belum tersedia, silahkan hubungi administrator untuk menambahkan</p>
    </div>
    ...
    <div class="col-sm-4">
        <select readonly="" name="id_jenis_bangunan" id="id_jenis_bangunan" class="form-control input-sm">
            ...
            <?php if($jenis_bangunan): foreach($jenis_bangunan as $r_jenis_bangunan): ?>
                <option <?php echo ($edit->id_jenis_bangunan == $r_jenis_bangunan->id_jenis_bangunan) ? 'selected=""' : '' ?> value="<?php echo $r_jenis_bangunan->id_jenis_bangunan ?>"><?php echo $r_jenis_bangunan->nama_jenis_bangunan ?></option>
    ...
    <div class="col-sm-4">
        <select readonly="" name="id_hak_kepemilikan" id="id_hak_kepemilikan" class="form-control input-sm">
            ...
            <?php if($kepemilikan_tanah): foreach($kepemilikan_tanah as $r_kepemilikan_tanah): ?>
                <option <?php echo ($edit->id_hak_kepemilikan == $r_kepemilikan_tanah->id_hak_kepemilikan) ? 'selected=""' : '' ?> value="<?php echo $r_kepemilikan_tanah->id_hak_kepemilikan ?>"><?php echo $r_kepemilikan_tanah->nama_hak_kepemilikan ?></option>
            <?php endforeach; endif; ?>
        </select>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <input readonly="" type="number" step="any" class="form-control input-sm" name="luas_bangunan" id="luas_bangunan" value="<?php echo $edit->luas_bangunan ?>">
    ...
    <div class="col-sm-4">
        ...
        <select readonly="" class="form-control input-sm" name="id_koif_tingkat" id="id_koif_tingkat">
            ...
            <?php if($koif_tingkat): foreach($koif_tingkat as $r_koif_tingkat): ?>
                <option <?php echo ($edit->id_koif_tingkat == $r_koif_tingkat->id_koif_tingkat) ? 'selected=""' : '' ?> value="<?php echo $r_koif_tingkat->id_koif_tingkat ?>" nilai_koif_tingkat="<?php echo $r_koif_tingkat->nilai_koif_tingkat; ?>"><?php echo $r_koif_tingkat->nama_koif_tingkat ?></option>
            <?php endforeach; endif; ?>
        </select>
    ...
    <div class="col-sm-4">
        <select readonly="" class="form-control input-sm" name="id_koif_guna" id="id_koif_guna">
            ...
            <?php if($koif_guna): foreach($koif_guna as $r_koif_guna): ?>
                <option <?php echo ($edit->id_koif_guna == $r_koif_guna->id_koif_guna) ? 'selected=""' : '' ?> value="<?php echo $r_koif_guna->id_koif_guna ?>" nilai_koif_guna="<?php echo $r_koif_guna->nilai_koif_guna ?>"><?php echo $r_koif_guna->nama_koif_guna ?></option>
            <?php endforeach; endif; ?>
        </select>
    </div>
    ...
    <div class="col-sm-4">
        <select readonly="" class="form-control input-sm" name="id_harga_dasar" id="id_harga_dasar">
            ...
            <?php if($harga_dasar_bangunan): foreach($harga_dasar_bangunan as $r_harga_dasar_bangunan): ?>
                <option <?php echo ($edit->id_harga_dasar == $r_harga_dasar_bangunan->id_harga_dasar) ? 'selected=""' : '' ?> value="<?php echo $r_harga_dasar_bangunan->id_harga_dasar ?>" nilai_harga_dasar="<?php echo $r_harga_dasar_bangunan->nilai_harga_dasar ?>"><?php echo $r_harga_dasar_bangunan->jenis_bangunan ?></option>
            <?php endforeach; endif; ?>
        </select>
    </div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input readonly="" value="<?php echo $edit->tanggal_peninjauan_lapangan ?>" type="date" class="form-control input-sm" name="tanggal_peninjauan_lapangan" id="tanggal_peninjauan_lapangan" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6"><input placeholder="Isikan No Sertifikat Tanah" value="<?php echo $edit->no_sertifikat_tanah ?>" type="text" name="no_sertifikat_tanah" id="no_sertifikat_tanah" class="form-control input-sm"></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3"><input readonly="" value="<?php echo $edit->tanggal_terbit ?>" type="date" name="tanggal_terbit" id="tanggal_terbit" class="form-control input-sm"></div>
</div>
