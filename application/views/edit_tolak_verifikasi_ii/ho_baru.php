...
<?php if($edit->tinggi_tower > 0): ?>
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input readonly=""  value="<?php echo $edit->tinggi_tower ?>" type="number" class="form-control input-sm" name="ho_baru_tinggi_tower" id="ho_baru_tinggi_tower">
        </div>
    </div>
<?php endif; ?>
...
<div class="form-group">
    ...
    <div class="col-sm-1">
        <input readonly="" type="text"  class="form-control input-sm" name="ho_baru_nilai_index_gangguan" id="ho_baru_nilai_index_gangguan">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-1">
        <input readonly="" type="text"  class="form-control input-sm" name="ho_baru_nilai_index_lokasi" id="ho_baru_nilai_index_lokasi">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-1">
        <input readonly="" type="text"  class="form-control input-sm" name="ho_baru_nilai_index_harga_dasar" id="ho_baru_nilai_index_harga_dasar">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <input readonly="" value="<?php echo $edit->nilai_retribusi ?>" type="text" class="form-control input-sm" name="ho_baru_nilai_retribusi" class="ho_baru_nilai_retribusi" id="ho_baru_nilai_retribusi">
    </div>
</div>
