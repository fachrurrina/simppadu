...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input  value="<?php echo $edit->nama_klinik; ?>" type="text" class="form-control input-sm" name="nama_klinik" id="nama_klinik" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input  value="<?php echo $edit->jasa_pelayanan ?>" type="text" class="form-control input-sm" name="jasa_pelayanan" id="jasa_pelayanan" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6"><textarea  name="alamat_klinik" id="alamat_klinik" class="form-control input-sm"><?php echo $edit->alamat_klinik ?></textarea></div>
</div>

<div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Kecamatan Klinik</label>
    <div class="col-sm-4">
        <select  name="id_kec_klinik" id="id_kec_klinik" class="form-control input-sm">
            <option value=""></option>
            <?php foreach ($kec as $r_kec): ?>
                <option <?php echo ($edit->id_kec_klinik == $r_kec->id_kec) ? 'selected=""' : '' ?> value="<?php echo $r_kec->id_kec; ?>"><?php echo $r_kec->nm_kec; ?></option>
            <?php endforeach; ?>
        </select>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select  name="id_kel_klinik" id="id_kel_klinik" class="form-control input-sm">
            <option value=""></option>
            <?php foreach ($kel as $r_kel): ?>
                <option <?php echo ($edit->id_kel_klinik == $r_kel->id_kel) ? 'selected=""' : '' ?> value="<?php echo $r_kel->id_kel; ?>"><?php echo $r_kel->nm_kel; ?></option>
            <?php endforeach; ?>
        </select>
        <p class="help-block">Jika ada kecamatan atau gampong yang belum tersedia, silahkan hubungi administrator untuk menambahkan</p>
    </div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input  value="<?php echo $edit->nama_pimpinan ?>" type="text" class="form-control input-sm" name="nama_pimpinan" id="nama_pimpinan" />
    </div>
</div>
