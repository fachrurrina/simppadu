    ...
    <div class="col-sm-4">
        <select readonly="" name="id_kel_pemilik" id="id_kel_pemilik" class="form-control input-sm">
            ...
            <?php foreach ($kel as $r_kel): ?>
                <option <?php echo ($verifikasi->id_kel_optik == $r_kel->id_kel) ? 'selected=""' : '' ?> value="<?php echo $r_kel->id_kel; ?>"><?php echo $r_kel->nm_kel; ?></option>
            <?php endforeach; ?>
        </select>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <input readonly="" value="<?php echo $verifikasi->no_surat_izin_kerja ?>" type="text" class="form-control input-sm" name="no_surat_izin_kerja" id="no_surat_izin_kerja" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input readonly="" value="<?php echo $verifikasi->nama_optik; ?>" type="text" class="form-control input-sm" name="nama_optik" id="nama_optik" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6"><textarea readonly="" name="alamat_optik" id="alamat_optik" class="form-control input-sm"><?php echo $verifikasi->alamat_optik ?></textarea></div>
</div>

<div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Kecamatan Optik</label>
    <div class="col-sm-4">
        <select readonly="" name="id_kec_optik" id="id_kec_optik" class="form-control input-sm">
            <option value=""></option>
            <?php foreach ($kec as $r_kec): ?>
                <option <?php echo ($verifikasi->id_kec_optik == $r_kec->id_kec) ? 'selected=""' : '' ?> value="<?php echo $r_kec->id_kec; ?>"><?php echo $r_kec->nm_kec; ?></option>
            <?php endforeach; ?>
        </select>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select readonly="" name="id_kel_optik" id="id_kel_optik" class="form-control input-sm">
            <option value=""></option>
            <?php foreach ($kel as $r_kel): ?>
                <option <?php echo ($verifikasi->id_kel_optik == $r_kel->id_kel) ? 'selected=""' : '' ?> value="<?php echo $r_kel->id_kel; ?>"><?php echo $r_kel->nm_kel; ?></option>
            <?php endforeach; ?>
