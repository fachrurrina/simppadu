...
<?php if($verifikasi->tinggi_tower > 0): ?>
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input readonly=""  value="<?php echo $verifikasi->tinggi_tower ?>" type="number" class="form-control input-sm" name="ho_perpanjangan_tinggi_tower" id="ho_perpanjangan_tinggi_tower">
        </div>
    </div>
<?php endif; ?>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <input readonly="" value="<?php echo $verifikasi->nilai_retribusi ?>" type="text" class="form-control input-sm" name="ho_perpanjangan_nilai_retribusi" class="ho_perpanjangan_nilai_retribusi" id="ho_perpanjangan_nilai_retribusi">
    </div>
</div>
