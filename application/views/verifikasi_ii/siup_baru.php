...
<div class="form-group">
    ...
    <div class="col-sm-3"><input readonly="" value="<?php echo $verifikasi->modal_perusahaan ?>" type="number" name="modal_perusahaan" id="modal_perusahaan" value="" class="form-control input-sm"></div>
    ...
    <div class="col-sm-1"><input readonly="" value="<?php echo get_status_modal_perusahaan($verifikasi->modal_perusahaan) ?>" readonly="" type="text" class="form-control input-sm" name="ket_status_modal" id="ket_status_modal"></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-2">
        <input value="<?php echo $verifikasi->tenaga_kerja_a ?>" readonly="" type="number" name="tenaga_kerja_a" id="tenaga_kerja_a" class="form-control input-sm">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-2">
        <input value="<?php echo $verifikasi->tenaga_kerja_b ?>" readonly="" type="number" name="tenaga_kerja_b" id="tenaga_kerja_b" class="form-control input-sm">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-2">
        <input value="<?php echo $verifikasi->tenaga_kerja_c ?>" readonly="" type="number" name="tenaga_kerja_c" id="tenaga_kerja_c" class="form-control input-sm">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-2">
        <input value="<?php echo $verifikasi->tenaga_kerja_d ?>" readonly="" type="number" name="tenaga_kerja_d" id="tenaga_kerja_d" class="form-control input-sm">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6"><input readonly="" value="<?php echo $verifikasi->tanggal_terbit ?>" type="date" name="tanggal_terbit" id="tanggal_terbit" value="" class="form-control input-sm"></div>
</div>
<div class="form-group">
    <label for="" class="col-sm-2 control-label">Tanggal berlaku</label>
    <div class="col-sm-6"><input readonly="" value="<?php echo $verifikasi->tanggal_perpanjangan ?>" type="date" name="tanggal_perpanjangan" id="tanggal_perpanjangan" value="" class="form-control input-sm"></div>
</div>