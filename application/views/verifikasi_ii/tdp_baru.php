...
<div class="form-group">
    ...
    <div class="col-sm-2"><input value="<?php echo $verifikasi->tanggal_daftar ?>" readonly="" type="date" name="tanggal_daftar" id="tanggal_daftar" class="form-control input-sm"></div>
</div>

<?php $no_sk_exist = $this->m_tdp->check_no_sk_exist($verifikasi->no_sk); ?>

<div class="form-group <?php echo ($no_sk_exist) ? 'has-error' : '' ; ?>">    
    ...
    <div class="col-sm-3">
        ...
        <?php echo ($no_sk_exist) ? '<p class="help-block">No sk sudah pernah digunakan!!!</p>' : '' ?>
    </div>
</div>
