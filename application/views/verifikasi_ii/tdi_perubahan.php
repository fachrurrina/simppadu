...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input readonly="" value="<?php echo $verifikasi->nipik ?>" type="text" class="form-control input-sm" name="nipik" id="nipik" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <ul>
            <?php foreach(explode('|', $verifikasi->id_kbli) as $id_kbli): ?>
...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <input readonly="" value="<?php echo $verifikasi->komoditi_industri ?>" type="text" class="form-control input-sm" name="komoditi_industri" id="komoditi_industri" />
    </div>
</div>

<div class="form-group">
    <label for="" class="col-sm-2 control-label">Alamat Pabrik</label>
    <div class="col-sm-6"><textarea readonly="" name="alamat_pabrik" id="alamat_pabrik" class="form-control input-sm"><?php echo $verifikasi->alamat_pabrik ?></textarea></div>
</div>

<div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Kecamatan Pabrik</label>
    <div class="col-sm-4">
        <select readonly="" name="id_kec_pabrik" id="id_kec_pabrik" class="form-control input-sm">
            <option value=""></option>
            <?php foreach ($kec as $r_kec): ?>
                <option <?php echo ($verifikasi->id_kec_pabrik == $r_kec->id_kec) ? 'selected=""' : ''; ?> value="<?php echo $r_kec->id_kec; ?>"><?php echo $r_kec->nm_kec; ?></option>
            <?php endforeach; ?>
        </select>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select readonly="" name="id_kel_pabrik" id="id_kel_pabrik" class="form-control input-sm">
            <option value=""></option>
            <?php foreach ($kel as $r_kel): ?>
                <option <?php echo ($verifikasi->id_kel_pabrik == $r_kel->id_kel) ? 'selected=""' : ''; ?> value="<?php echo $r_kel->id_kel; ?>"><?php echo $r_kel->nm_kel; ?></option>
            <?php endforeach; ?>
        </select>
        <p class="help-block">Jika ada kecamatan atau gampong yang belum tersedia, silahkan hubungi administrator untuk menambahkan</p>
    </div>
...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <input readonly="" value="<?php echo $verifikasi->mesin_utama ?>" type="text" class="form-control input-sm" name="mesin_utama" id="mesin_utama" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <input readonly="" value="<?php echo $verifikasi->mesin_pembantu ?>" type="text" class="form-control input-sm" name="mesin_pembantu" id="mesin_pembantu" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <input readonly="" value="<?php echo $verifikasi->tenaga_penggerak ?>" type="text" class="form-control input-sm" name="tenaga_penggerak" id="tenaga_penggerak" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input readonly="" value="<?php echo $verifikasi->nilai_investasi ?>" type="number" class="form-control input-sm" name="nilai_investasi" id="nilai_investasi" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-2">
        <input readonly="" value="<?php echo $verifikasi->kapasitas_produksi ?>" type="text" class="form-control input-sm" name="kapasitas_produksi" id="kapasitas_produksi" />
    </div>
</div>
