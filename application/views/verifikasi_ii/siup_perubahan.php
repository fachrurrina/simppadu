...
<div class="form-group">
    ...
    <div class="col-sm-1"><input readonly="" value="<?php echo $verifikasi->tenaga_kerja_a ?>" type="number" name="tenaga_kerja_a" id="tenaga_kerja_a" class="form-control input-sm"></div>
    <label for="" class="col-sm-1 control-label">B</label>
    <div class="col-sm-1"><input readonly="" value="<?php echo $verifikasi->tenaga_kerja_b ?>" type="number" name="tenaga_kerja_b" id="tenaga_kerja_b" class="form-control input-sm"></div>
    <label for="" class="col-sm-1 control-label">C</label>
    <div class="col-sm-1"><input readonly="" value="<?php echo $verifikasi->tenaga_kerja_c ?>" type="number" name="tenaga_kerja_c" id="tenaga_kerja_c" class="form-control input-sm"></div>
    <label for="" class="col-sm-1 control-label">D</label>
    <div class="col-sm-1"><input readonly="" value="<?php echo $verifikasi->tenaga_kerja_d ?>" type="number" name="tenaga_kerja_d" id="tenaga_kerja_d" class="form-control input-sm"></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6"><textarea readonly="" rows="6" name="barang_jasa_dagangan_utama" id="barang_jasa_dagangan_utama" class="form-control input-sm"><?php echo $verifikasi->barang_jasa_dagangan_utama ?></textarea></div>
</div>
