...
<div class="form-group">
    ...
    <div class="col-sm-2">
        <input readonly="" value="<?php echo ($verifikasi->panjang_tempat_usaha * $verifikasi->lebar_tempat_usaha); ?>" type="number" class="form-control input-sm" name="luas_tempat_usaha" id="luas_tempat_usaha" />
    </div>
