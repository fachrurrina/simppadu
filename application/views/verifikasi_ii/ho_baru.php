...
<div class="form-group">
    ...
    <div class="col-sm-2" style="padding-top: 3px;">
        ...
        <label>
            <input readonly="" <?php echo ($verifikasi->jenis_kelamin_pemilik == 1)? 'checked=""' : '' ?> type="radio" name="jenis_kelamin_pemilik" value="1" id="jenis_kelamin_pemilik"  /> 
            Laki-laki
        </label>

        <label>
            <input readonly="" <?php echo ($verifikasi->jenis_kelamin_pemilik == 2)? 'checked=""' : '' ?> type="radio" name="jenis_kelamin_pemilik" value="0" id="jenis_kelamin_pemilik"  /> 
            Perempuan
        </label>
...
<div class="form-group">
    ...
    <div class="col-sm-4"><input readonly="" value="<?php echo $verifikasi->tanggal_peninjauan_lapangan ?>" type="date" name="tanggal_peninjauan_lapangan" id="tanggal_peninjauan_lapangan" class="form-control input-sm"></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        ...
        <table class="table" style="margin-bottom: 2px;" id="table-luas">
            <tbody>
                <?php  
                $array_ket_luas_tempat_usaha = explode('|', $verifikasi->ket_luas_tempat_usaha);
                $array_panjang_tempat_usaha = explode('|', $verifikasi->panjang_tempat_usaha);
                $array_lebar_tempat_usaha   = explode('|', $verifikasi->lebar_tempat_usaha);
                
                for($i = 0; $i < count($array_panjang_tempat_usaha); $i++):
                ?>
                <tr>
                    <td><input readonly="" value="<?php echo $array_ket_luas_tempat_usaha[$i] ?>" type="text" class="ho_baru_ket_luas_tempat_usaha form-control input-sm" name="ho_baru_ket_luas_tempat_usaha[]" id="ho_baru_ket_luas_tempat_usaha[]" /></td>
                    <td><input readonly="" value="<?php echo $array_panjang_tempat_usaha[$i] ?>" type="number" class="ho_baru_panjang_tempat_usaha form-control input-sm" name="ho_baru_panjang_tempat_usaha[]" id="ho_baru_panjang_tempat_usaha[]" /></td>
                    <td><input readonly="" value="<?php echo $array_lebar_tempat_usaha[$i] ?>" type="number" class="ho_baru_lebar_tempat_usaha form-control input-sm" name="ho_baru_lebar_tempat_usaha[]" id="ho_baru_lebar_tempat_usaha[]" /></td>
            ...
            <tfoot>
                ...
                <tr>
                    <td>Sub Total :</td>
                    <td><input readonly="" value="" type="number" class="form-control input-sm" name="ho_baru_panjang_tempat_usaha_total" id="ho_baru_panjang_tempat_usaha_total" /></td>
                    <td><input readonly="" value="" type="number" class="form-control input-sm" name="ho_baru_lebar_tempat_usaha_total" id="ho_baru_lebar_tempat_usaha_total" /></td>
                    
                </tr>
                <tr>
                    <td>Total Luas Tempat Usaha :</td>
                    <td></td>
                    <td><input readonly="" value="" type="number" class="form-control input-sm" name="ho_baru_luas_tempat_usaha" id="ho_baru_luas_tempat_usaha" /></td>
                ...
                <tr>
                    ...
                    <td></td>
                    <td><input readonly="" value="" type="number" class="form-control input-sm" name="ho_baru_nilai_index_luas" id="ho_baru_nilai_index_luas" /></td>
        ...
        function jumlahkan(){
            ...
            var sum_panjang = 0;
            $('.ho_baru_panjang_tempat_usaha').each(function(){
                if(isInt(this.value)){
            ...
            $('#ho_baru_panjang_tempat_usaha_total').val(sum_panjang);

            var sum_lebar = 0;
            $('.ho_baru_lebar_tempat_usaha').each(function(){
                if(isInt(this.value)){
            ...
            $('#ho_baru_lebar_tempat_usaha_total').val(sum_lebar);

            $('#ho_baru_luas_tempat_usaha').val(sum_panjang * sum_lebar);

            var ho_baru_luas_tempat_usaha = sum_panjang * sum_lebar;
...
<?php if($verifikasi->tinggi_tower > 0): ?>
    <div class="form-group">
        <label for="inputEmail3" class="col-sm-2 control-label">Tinggi Tower</label>
        <div class="col-sm-4">
            <input readonly=""  value="<?php echo $verifikasi->tinggi_tower ?>" type="number" class="form-control input-sm" name="ho_baru_tinggi_tower" id="ho_baru_tinggi_tower">
        </div>
    </div>
<?php endif; ?>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        ...
        <select readonly="" class="form-control input-sm" name="ho_baru_kode_index_gangguan" id="ho_baru_kode_index_gangguan">
            <option></option>
            <?php if($index_gangguan): foreach($index_gangguan as $r_index_gangguan): ?>
                <option <?php echo ($verifikasi->kode_index_gangguan == $r_index_gangguan->kode_index_gangguan) ? 'selected=""' : '' ?> value="<?php echo $r_index_gangguan->kode_index_gangguan ?>" nilai_index_gangguan="<?php echo $r_index_gangguan->nilai_index_gangguan; ?>"><?php echo $r_index_gangguan->nama_index_gangguan ?></option>
            <?php endforeach; endif; ?>
        </select>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select readonly="" class="form-control input-sm" name="ho_baru_kode_index_lokasi" id="ho_baru_kode_index_lokasi">
            <option></option>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select readonly="" class="form-control input-sm" name="ho_baru_kode_index_harga_dasar" id="ho_baru_kode_index_harga_dasar">
            <option></option>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <input readonly="" value="<?php echo $verifikasi->nilai_retribusi ?>" type="text" class="form-control input-sm" name="ho_baru_nilai_retribusi" class="ho_baru_nilai_retribusi" id="ho_baru_nilai_retribusi">
    </div>
</div>


<!-- element input hidden untuk data yang akan di simpan ke t_ho -->
<input value="<?php echo $verifikasi->tinggi_tower ?>" type="hidden" name="tinggi_tower" id="tinggi_tower" >
<input value="<?php echo $verifikasi->ket_luas_tempat_usaha ?>" type="hidden" name="ket_luas_tempat_usaha" id="ket_luas_tempat_usaha" >
<input value="<?php echo $verifikasi->panjang_tempat_usaha ?>" type="hidden" name="panjang_tempat_usaha" id="panjang_tempat_usaha" >
<input value="<?php echo $verifikasi->lebar_tempat_usaha ?>" type="hidden" name="lebar_tempat_usaha" id="lebar_tempat_usaha" >
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <select readonly="" class="form-control input-sm" name="status_kepemilikan_tanah" id="status_kepemilikan_tanah">
            <option <?php echo ($verifikasi->status_kepemilikan_tanah == "Hak Milik") ? 'selected=""' : '' ?> value="Hak Pakai">Hak Milik</option>
            <option <?php echo ($verifikasi->status_kepemilikan_tanah == "Hak Pakai") ? 'selected=""' : '' ?> value="Hak Pakai">Hak Pakai</option>
            <option <?php echo ($verifikasi->status_kepemilikan_tanah == "Sewa") ? 'selected=""' : '' ?> value="Hak Pakai">Sewa</option>
        </select>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-4"><input readonly="" value="<?php echo $verifikasi->tanggal_surat_ket_usaha ?>" type="date" name="tanggal_surat_ket_usaha" id="tanggal_surat_ket_usaha" class="form-control input-sm"></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-4"><input readonly="" value="<?php echo $verifikasi->tanggal_surat_pernyataan_lingkungan ?>" type="date" name="tanggal_surat_pernyataan_lingkungan" id="tanggal_surat_pernyataan_lingkungan" class="form-control input-sm"></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-4"><input readonly="" value="<?php echo $verifikasi->tanggal_daftar_ulang ?>" type="date" name="tanggal_terbit" id="tanggal_terbit" class="form-control input-sm"></div>
</div>
<div class="form-group">
