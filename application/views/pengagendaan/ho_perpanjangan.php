...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input readonly="" value="<?php echo $fo->ho_perpanjangan_no_sk; ?>" type="text" class="form-control input-sm" name="no_sk_lalu"  id="no_sk_lalu"  />
    </div>
</div>
...
<div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">Tanggal Daftar Ulang</label>
    <div class="col-sm-3">
        <input type="date" class="form-control input-sm" name="tanggal_daftar_ulang"  id="tanggal_daftar_ulang" />
    </div>
</div>
