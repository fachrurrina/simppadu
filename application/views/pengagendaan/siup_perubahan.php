...
<div class="form-group">
    ...
    <div class="col-sm-2" style="padding-top: 3px;">
        <label>
            <input <?php echo ($fo->siup_perubahan_alasan_penerbitan == 'PL') ? 'checked=""' : ''; ?> disabled="" type="radio" name="alasan_penerbitan" value="PL" id="siup_perubahan_status_perubahan" /> 
            Perubahan Lain-lain (PL)
        </label>
    </div>
    <div class="col-sm-2" style="padding-top: 3px;">
        <label>
            <input <?php echo ($fo->siup_perubahan_alasan_penerbitan == 'PS') ? 'checked=""' : ''; ?> disabled="" type="radio" name="alasan_penerbitan" value="PS" id="siup_perubahan_status_perubahan"  /> 
            Perubahan Status (PS)
        </label>
    </div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $fo->siup_perubahan_no_sk; /* ini adalah no sk lalu */ ?>" readonly="" type="text" class="form-control input-sm" name="no_sk_lalu"  id="no_sk_lalu"  />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        ...
        <select 
        <?php
            if($fo->siup_perubahan_alasan_penerbitan == 'PS'){
                echo 'readonly=""';
            }
