<div class="form-group">
    ...
    <div class="col-sm-3">
        <input type="text" class="form-control input-sm" name="sipk_baru_nama_kapal" id="sipk_baru_nama_kapal" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input type="text" class="form-control input-sm" name="sipk_baru_nama_pemilik" id="sipk_baru_nama_pemilik" />
