...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input type="text" class="form-control input-sm" name="sipo_baru_nama_pemilik" id="sipo_baru_nama_pemilik" />
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input type="text" class="form-control input-sm" name="sipo_baru_nama_optik" id="sipo_baru_nama_optik" />
    </div>
</div>
