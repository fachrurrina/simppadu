...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input type="text" class="form-control input-sm" name="sia_baru_nama_pemilik" id="sia_baru_nama_pemilik" />
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input type="text" class="form-control input-sm" name="sia_baru_nama_apotik" id="sia_baru_nama_apotik" />
    </div>
</div>
