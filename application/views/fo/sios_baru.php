...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input type="text" class="form-control input-sm" name="sios_baru_nama_pemilik" id="sios_baru_nama_pemilik" />
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input type="text" class="form-control input-sm" name="sios_baru_nama_rumah_sakit" id="sios_baru_nama_rumah_sakit" />
    </div>
</div>
