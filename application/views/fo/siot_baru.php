...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input type="text" class="form-control input-sm" name="siot_baru_nama_pemilik" id="siot_baru_nama_pemilik" />
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input type="text" class="form-control input-sm" name="siot_baru_nama_rumah_sakit" id="siot_baru_nama_rumah_sakit" />
    </div>
</div>
