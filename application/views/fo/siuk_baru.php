<div class="form-group">
    ...
    <div class="col-sm-3">
        <input type="text" class="form-control input-sm" name="siuk_baru_nama_perusahaan" id="siuk_baru_nama_perusahaan" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input type="text" class="form-control input-sm" name="siuk_baru_nama_pemilik" id="siuk_baru_nama_pemilik" />
...
<div class="form-group" style="margin-bottom: 0">
    ...
    <div class="col-sm-5">
        <input value="" type="text" class="form-control input-sm" id="siuk_baru_jenis_usaha" name="siuk_baru_jenis_usaha" />
    </div>
