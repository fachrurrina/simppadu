<div class="form-group">
    ...
    <div class="col-sm-3">
        <input type="text" class="form-control input-sm" name="tdi_baru_nama_perusahaan" id="tdi_baru_nama_perusahaan" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input type="text" class="form-control input-sm" name="tdi_baru_nama_pemilik" id="tdi_baru_nama_pemilik" />
