<div class="form-group">
    ...
    <div class="col-sm-3">
        <input type="text" class="form-control input-sm" name="siuakb_baru_nama_perusahaan" id="siuakb_baru_nama_perusahaan" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input type="text" class="form-control input-sm" name="siuakb_baru_nama_pemilik" id="siuakb_baru_nama_pemilik" />
        <label style="padding-top: 10px;">
            ...
            $('#samakan_nama').click(function(){
                if($(this).is(':checked')){
                    ...
                    $('#siuakb_baru_nama_pemilik').val(nama_pemohon);
                }else{
                    $('#siuakb_baru_nama_pemilik').val('');
                }
            });
            </script>
        </label>
...
<div class="form-group" style="margin-bottom: 0">
    ...
    <div class="col-sm-5">
        <input value="" type="text" class="form-control input-sm" id="siuakb_baru_jenis_usaha" name="siuakb_baru_jenis_usaha" />
    </div>
