<div class="form-group">
    ...
    <div class="col-sm-3">
        <input type="text" class="form-control input-sm" name="situ_baru_nama_perusahaan" id="situ_baru_nama_perusahaan" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input type="text" class="form-control input-sm" name="situ_baru_nama_pemilik" id="situ_baru_nama_pemilik" />
...
<div class="form-group" style="margin-bottom: 0">
    ...
    <div class="col-sm-5">
        <input value="" type="text" class="form-control input-sm" id="situ_baru_jenis_usaha" name="situ_baru_jenis_usaha" />
    </div>
