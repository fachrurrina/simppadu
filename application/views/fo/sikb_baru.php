...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input type="text" class="form-control input-sm" name="sikb_baru_nama_pemilik" id="sikb_baru_nama_pemilik" />
        <label style="padding-top: 10px;">
            ...
            $('#samakan_nama').click(function(){
                if($(this).is(':checked')){
                    ...
                    $('#sikb_baru_nama_pemilik').val(nama_pemohon);
                }else{
                    $('#sikb_baru_nama_pemilik').val('');
                }
            });
            </script>
        </label>
...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <input type="text" class="form-control input-sm" name="sikb_baru_nama_tempat_kerja" id="sikb_baru_nama_tempat_kerja" />
    </div>
</div>
