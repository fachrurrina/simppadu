<div class="form-group">
    ...
    <div class="col-sm-3">
        <input type="text" class="form-control input-sm" name="siup_baru_nama_perusahaan" id="siup_baru_nama_perusahaan" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input type="text" class="form-control input-sm" name="siup_baru_nama_pemilik" id="siup_baru_nama_pemilik" />
...
<div class="form-group" style="margin-bottom: 0">
    ...
    <div class="col-sm-5">
        <input value="" type="text" class="form-control input-sm" id="siup_baru_jenis_usaha" name="siup_baru_jenis_usaha" />
    </div>
</div>
