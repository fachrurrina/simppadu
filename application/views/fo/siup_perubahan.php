...
<div class="form-group" id="alasan_penerbitan" >
    ...
    <div class="col-sm-2" style="padding-top: 3px;">
        ...
        <label>
            <input type="radio" name="siup_perubahan_alasan_penerbitan" value="PL" id="siup_perubahan_alasan_penerbitan" checked="" /> 
            Perubahan Lain-lain
        </label>
    ...
    <div class="col-sm-2" style="padding-top: 3px;">
        ...
        <label>
            <input type="radio" name="siup_perubahan_alasan_penerbitan" value="PS" id="siup_perubahan_alasan_penerbitan"  /> 
            Perubahan Status 
        </label>
