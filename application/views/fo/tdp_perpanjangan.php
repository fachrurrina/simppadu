...
<div class="form-group">
    ...
    <div class="col-sm-1" style="padding-top: 3px;">
        ...
        <label>
            <input type="checkbox" value="1" name="tdp_perpanjangan_status_perubahan" class="tdp_perpanjangan_status_perubahan" id="tdp_perpanjangan_status_perubahan"/> 
        </label>
...
<div class="form-group" id="alasan_penerbitan" style="display:none;">
    ...
    <div class="col-sm-2" style="padding-top: 3px;">
        ...
        <label>
            <input type="radio" name="tdp_perpanjangan_alasan_penerbitan" value="PL" id="tdp_perpanjangan_alasan_penerbitan" checked="" /> 
            Perubahan Lain-lain
        </label>
    ...
    <div class="col-sm-2" style="padding-top: 3px;">
        ...
        <label>
            <input type="radio" name="tdp_perpanjangan_alasan_penerbitan" value="PS" id="tdp_perpanjangan_alasan_penerbitan"  /> 
            Perubahan Status 
        </label>
