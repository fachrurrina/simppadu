...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $edit->sikp_baru_nama_pemilik ?>" type="text" class="form-control input-sm" name="sikp_baru_nama_pemilik" id="sikp_baru_nama_pemilik" />
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $edit->sikp_baru_nama_tempat_praktek ?>" type="text" class="form-control input-sm" name="sikp_baru_nama_tempat_praktek" id="sikp_baru_nama_tempat_praktek" />
    </div>
</div>
