...
<div class="form-group">
    ...
    <div class="col-sm-5">
        <input value="<?php echo $edit->sipo_perpanjangan_no_sk; ?>" type="text" class="form-control input-sm" name="keyword_no_sk" id="keyword_no_sk" />
    </div>
    <div class="col-sm-3">
...
<script type="text/javascript">
    $('#cari').click(function(){
        ...
        $.get("<?php echo site_url('c_ajax/load_data_sipo_perpanjangan'); ?>", {
            no_sk : keyword_no_sk
        }, function(data){
            console.log(data);
...
<table class="table table-striped table-condensed" id="table_data">
    ...
    <tbody>
        <?php 
        $no_sk = $edit->sipo_perpanjangan_no_sk; 
        $data = $this->m_sipo->get_where_no_sk($no_sk);
        ?>
        <tr>
            <input type="hidden" name="sipo_perpanjangan_no_sk" id="sipo_perpanjangan_no_sk" value="<?php echo $edit->sipo_perpanjangan_no_sk; ?>">
...
<div class="form-group">
    ...
    <div class="col-sm-1" style="padding-top: 3px;">
        ...
        <label>
            <input <?php echo ($edit->sipo_perpanjangan_status_perubahan == 1) ? 'checked=""' : ''; ?> type="checkbox" value="1" name="sipo_perpanjangan_status_perubahan" class="sipo_perpanjangan_status_perubahan" id="sipo_perpanjangan_status_perubahan"/> 
        </label>
