<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $edit->siujk_baru_nama_perusahaan ?>" type="text" class="form-control input-sm" name="siujk_baru_nama_perusahaan" id="siujk_baru_nama_perusahaan" />
    </div>
</div>
    ...
    <div class="col-sm-3">
        <select  class="form-control input-sm" name="siujk_baru_id_bentuk_perusahaan" id="siujk_baru_id_bentuk_perusahaan">
            ...
            <?php if($bentuk_perusahaan): foreach($bentuk_perusahaan as $r_bentuk_perusahaan): ?>
                <option <?php echo ($edit->siujk_baru_id_bentuk_perusahaan == $r_bentuk_perusahaan->id_bentuk_perusahaan) ? 'selected=""' : ''; ?> value="<?php echo $r_bentuk_perusahaan->id_bentuk_perusahaan ?>"><?php echo $r_bentuk_perusahaan->nama_bentuk_perusahaan ?></option>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $edit->siujk_baru_nama_pemilik ?>" type="text" class="form-control input-sm" name="siujk_baru_nama_pemilik" id="siujk_baru_nama_pemilik" />
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $edit->siujk_baru_npwp ?>" type="text" class="form-control input-sm" name="siujk_baru_npwp" id="siujk_baru_npwp" />
    </div>
</div>
...
<div class="form-group" style="margin-bottom: 0">
    ...
    <div class="col-sm-5">
        <input value="<?php echo $edit->siujk_baru_jenis_usaha ?>" type="text" class="form-control input-sm" id="siujk_baru_jenis_usaha" name="siujk_baru_jenis_usaha" />
    </div>
