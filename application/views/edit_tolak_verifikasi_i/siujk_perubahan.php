...
<div class="form-group">
    ...
    <div class="col-sm-5">
        <input value="<?php echo $edit->siujk_perubahan_no_sk; ?>" type="text" class="form-control input-sm" name="keyword_no_sk" id="keyword_no_sk" />
    </div>
    <div class="col-sm-3">
...
<table class="table table-striped table-condensed" id="table_data">
    ...
    <tbody>
        <?php 
        $no_sk = $edit->siujk_perubahan_no_sk; 
        $data = $this->m_siujk->get_where_no_sk($no_sk);
        ?>
        <tr>
            <input type="hidden" name="siujk_perubahan_no_sk" id="siujk_perubahan_no_sk" value="<?php echo $edit->siujk_perubahan_no_sk; ?>">
