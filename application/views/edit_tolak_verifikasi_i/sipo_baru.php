...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $edit->sipo_baru_nama_pemilik ?>" type="text" class="form-control input-sm" name="sipo_baru_nama_pemilik" id="sipo_baru_nama_pemilik" />
        <label style="padding-top: 10px;">
            ...
            $('#samakan_nama').click(function(){
                if($(this).is(':checked')){
                    ...
                    $('#sipo_baru_nama_pemilik').val(nama_pemohon);
                }else{
                    $('#sipo_baru_nama_pemilik').val('');
                }
            });
            </script>
        </label>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $edit->sipo_baru_nama_optik ?>" type="text" class="form-control input-sm" name="sipo_baru_nama_optik" id="sipo_baru_nama_optik" />
    </div>
</div>
