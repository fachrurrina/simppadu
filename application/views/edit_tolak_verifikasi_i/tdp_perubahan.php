...
<div class="form-group">
    ...
    <div class="col-sm-5">
        <input value="<?php echo $edit->tdp_perubahan_no_sk; ?>" type="text" class="form-control input-sm" name="keyword_no_sk" id="keyword_no_sk" />
    </div>
    <div class="col-sm-3">
...
<table class="table table-striped table-condensed" id="table_data">
    ...
    <tbody>
        <?php 
        $no_sk = $edit->tdp_perubahan_no_sk; 
        $data = $this->m_tdp->get_where_no_sk($no_sk);
        ?>
        <tr>
            <input type="hidden" name="tdp_perubahan_no_sk" id="tdp_perubahan_no_sk" value="<?php echo $edit->tdp_perubahan_no_sk; ?>">
...
<div class="form-group" id="alasan_penerbitan" >
    ...
    <div class="col-sm-2" style="padding-top: 3px;">
        ...
        <label>
            <input <?php echo ($edit->tdp_perubahan_alasan_penerbitan == 'PL') ? 'checked=""' : '' ; ?> type="radio" name="tdp_perubahan_alasan_penerbitan" value="PL" id="tdp_perubahan_alasan_penerbitan" /> 
            Perubahan Lain-lain
        </label>
    ...
    <div class="col-sm-2" style="padding-top: 3px;">
        ...
        <label>
            <input <?php echo ($edit->tdp_perubahan_alasan_penerbitan == 'PS') ? 'checked=""' : '' ; ?> type="radio" name="tdp_perubahan_alasan_penerbitan" value="PS" id="tdp_perubahan_alasan_penerbitan"  /> 
            Perubahan Status 
        </label>
