<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $edit->siup_baru_nama_perusahaan ?>" type="text" class="form-control input-sm" name="siup_baru_nama_perusahaan" id="siup_baru_nama_perusahaan" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
    	<select class="form-control input-sm" name="siup_baru_id_bentuk_perusahaan" id="siup_baru_id_bentuk_perusahaan">
            <option></option>
	    	<?php if($bentuk_perusahaan): foreach($bentuk_perusahaan as $r_bentuk_perusahaan): ?>
	    		<option <?php echo ($edit->siup_baru_id_bentuk_perusahaan == $r_bentuk_perusahaan->id_bentuk_perusahaan) ? 'selected' : '' ; ?> value="<?php echo $r_bentuk_perusahaan->id_bentuk_perusahaan ?>"><?php echo $r_bentuk_perusahaan->nama_bentuk_perusahaan ?></option>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $edit->siup_baru_nama_pemilik ?>" type="text" class="form-control input-sm" name="siup_baru_nama_pemilik" id="siup_baru_nama_pemilik" />
        <label style="padding-top: 10px;">
            ...
            $('#samakan_nama').click(function(){
                if($(this).is(':checked')){
                    ...
                    $('#siup_baru_nama_pemilik').val(nama_pemohon);
                }else{
                    $('#siup_baru_nama_pemilik').val('');
                }
            });
            </script>
        </label>
...
<div class="form-group" style="margin-bottom: 0">
    ...
    <div class="col-sm-5">
        <input value="<?php echo $edit->siup_baru_jenis_usaha ?>" type="text" class="form-control input-sm" id="siup_baru_jenis_usaha" name="siup_baru_jenis_usaha" />
    </div>
</div>
