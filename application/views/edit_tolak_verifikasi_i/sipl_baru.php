<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $edit->sipl_baru_nama_perusahaan ?>" type="text" class="form-control input-sm" name="sipl_baru_nama_perusahaan" id="sipl_baru_nama_perusahaan" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <select  class="form-control input-sm" name="sipl_baru_id_bentuk_perusahaan" id="sipl_baru_id_bentuk_perusahaan">
            <option></option>
            <?php if($bentuk_perusahaan): foreach($bentuk_perusahaan as $r_bentuk_perusahaan): ?>
                <option <?php echo ($edit->sipl_baru_id_bentuk_perusahaan == $r_bentuk_perusahaan->id_bentuk_perusahaan) ? 'selected=""' : ''; ?> value="<?php echo $r_bentuk_perusahaan->id_bentuk_perusahaan ?>"><?php echo $r_bentuk_perusahaan->nama_bentuk_perusahaan ?></option>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $edit->sipl_baru_nama_pemilik ?>" type="text" class="form-control input-sm" name="sipl_baru_nama_pemilik" id="sipl_baru_nama_pemilik" />
        <label style="padding-top: 10px;">
            ...
            $('#samakan_nama').click(function(){
                if($(this).is(':checked')){
                    ...
                    $('#sipl_baru_nama_pemilik').val(nama_pemohon);
                }else{
                    $('#sipl_baru_nama_pemilik').val('');
                }
            });
            </script>
        </label>
