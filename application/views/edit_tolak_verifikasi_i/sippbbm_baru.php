<div class="form-group">
    ...
    <div class="col-sm-3">
        <input  value="<?php echo $edit->sippbbm_baru_pekerjaan_pemohon ?>" type="text" class="form-control input-sm" name="sippbbm_baru_pekerjaan_pemohon" id="sippbbm_baru_pekerjaan_pemohon" />
    </div>
</div>

<div class="form-group">
    <label for="" class="col-sm-2 control-label">Alamat Pemohon</label>
    <div class="col-sm-6"><textarea  name="sippbbm_baru_alamat_pemohon" id="sippbbm_baru_alamat_pemohon" class="form-control input-sm"><?php echo $edit->sippbbm_baru_alamat_pemohon ?></textarea></div>
</div>
    ...
    <div class="col-sm-4">
        <select  name="sippbbm_baru_id_kec_pemohon" id="sippbbm_baru_id_kec_pemohon" class="form-control input-sm">
            ...
            <?php foreach ($kec as $r_kec): ?>
                <option <?php echo ($edit->sippbbm_baru_id_kec_pemohon == $r_kec->id_kec) ? 'selected=""' : '' ?> value="<?php echo $r_kec->id_kec; ?>"><?php echo $r_kec->nm_kec; ?></option>
            <?php endforeach; ?>
        </select>
    </div>
</div>
    ...
    <div class="col-sm-4">
        <select  name="sippbbm_baru_id_kel_pemohon" id="sippbbm_baru_id_kel_pemohon" class="form-control input-sm">
            ...
            <?php foreach ($kel as $r_kel): ?>
                <option <?php echo ($edit->sippbbm_baru_id_kel_pemohon == $r_kel->id_kel) ? 'selected=""' : '' ?> value="<?php echo $r_kel->id_kel; ?>"><?php echo $r_kel->nm_kel; ?></option>
            <?php endforeach; ?>
        </select>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input  value="<?php echo $edit->sippbbm_baru_nama_perusahaan ?>" type="text" class="form-control input-sm" name="sippbbm_baru_nama_perusahaan" id="sippbbm_baru_nama_perusahaan" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input  value="<?php echo $edit->sippbbm_baru_nama_pemilik ?>" type="text" class="form-control input-sm" name="sippbbm_baru_nama_pemilik" id="sippbbm_baru_nama_pemilik" />
    </div>
</div>
