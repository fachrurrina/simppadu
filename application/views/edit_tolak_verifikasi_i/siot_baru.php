...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $edit->siot_baru_nama_pemilik ?>" type="text" class="form-control input-sm" name="siot_baru_nama_pemilik" id="siot_baru_nama_pemilik" />
        <label style="padding-top: 10px;">
            ...
            $('#samakan_nama').click(function(){
                if($(this).is(':checked')){
                    ...
                    $('#siot_baru_nama_pemilik').val(nama_pemohon);
                }else{
                    $('#siot_baru_nama_pemilik').val('');
                }
            });
            </script>
        </label>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $edit->siot_baru_nama_rumah_sakit ?>" type="text" class="form-control input-sm" name="siot_baru_nama_rumah_sakit" id="siot_baru_nama_rumah_sakit" />
    </div>
</div>
