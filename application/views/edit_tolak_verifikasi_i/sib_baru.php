<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $edit->sib_baru_nama_perusahaan ?>" type="text" class="form-control input-sm" name="sib_baru_nama_perusahaan" id="sib_baru_nama_perusahaan" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $edit->sib_baru_nama_pemilik ?>" type="text" class="form-control input-sm" name="sib_baru_nama_pemilik" id="sib_baru_nama_pemilik" />
