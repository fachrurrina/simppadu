...
<div class="form-group">
    ...
    <div class="col-sm-5">
        <input value="<?php echo $edit->ho_perubahan_no_sk; ?>" type="text" class="form-control input-sm" name="keyword_no_sk" id="keyword_no_sk" />
    </div>
    <div class="col-sm-3">
...
<script type="text/javascript">
    $('#cari').click(function(){
        ...
        $.get("<?php echo site_url('c_ajax/load_data_ho_perubahan'); ?>", {
            no_sk : keyword_no_sk
        }, function(data){
            console.log(data);
...
<table class="table table-striped table-condensed" id="table_data">
    ...
    <tbody>
        <?php 
        $no_sk = $edit->ho_perubahan_no_sk; 
        $data = $this->m_ho->get_where_no_sk($no_sk);
        ?>
        <tr>
            <input type="hidden" name="ho_perubahan_no_sk" id="ho_perubahan_no_sk" value="<?php echo $edit->ho_perubahan_no_sk; ?>">
