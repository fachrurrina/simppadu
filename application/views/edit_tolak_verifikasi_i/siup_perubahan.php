...
<div class="form-group">
    ...
    <div class="col-sm-5">
        <input value="<?php echo $edit->siup_perubahan_no_sk; ?>" type="text" class="form-control input-sm" name="keyword_no_sk" id="keyword_no_sk" />
    </div>
    <div class="col-sm-3">
...
<script type="text/javascript">
    $('#cari').click(function(){
        ...
        $.get("<?php echo site_url('c_ajax/load_data_siup_perubahan'); ?>", {
            no_sk : keyword_no_sk
        }, function(data){
...
<table class="table table-striped table-condensed" id="table_data">
    ...
    <tbody>
        <?php 
        $no_sk = $edit->siup_perubahan_no_sk; 
        $data = $this->m_siup->get_where_no_sk($no_sk);
        ?>
        <tr>
            <input type="hidden" name="siup_perubahan_no_sk" id="siup_perubahan_no_sk" value="<?php echo $edit->siup_perubahan_no_sk; ?>">
...
<div class="form-group" id="alasan_penerbitan" >
    ...
    <div class="col-sm-2" style="padding-top: 3px;">
        ...
        <label>
            <input <?php echo ($edit->siup_perubahan_alasan_penerbitan == 'PL') ? 'checked=""' : ''; ?> type="radio" name="siup_perubahan_alasan_penerbitan" value="PL" id="siup_perubahan_alasan_penerbitan"  /> 
            Perubahan Lain-lain
        </label>
    ...
    <div class="col-sm-2" style="padding-top: 3px;">
        ...
        <label>
            <input <?php echo ($edit->siup_perubahan_alasan_penerbitan == 'PS') ? 'checked=""' : ''; ?> type="radio" name="siup_perubahan_alasan_penerbitan" value="PS" id="siup_perubahan_alasan_penerbitan"  /> 
            Perubahan Status 
        </label>
