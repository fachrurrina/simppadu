...
<div class="form-group">
    ...
    <div class="col-sm-5">
        <input value="<?php echo $edit->sia_perpanjangan_no_sk; ?>" type="text" class="form-control input-sm" name="keyword_no_sk" id="keyword_no_sk" />
    </div>
    <div class="col-sm-3">
...
<table class="table table-striped table-condensed" id="table_data">
    ...
    <tbody>
        <?php 
        $no_sk = $edit->sia_perpanjangan_no_sk; 
        $data = $this->m_sia->get_where_no_sk($no_sk);
        ?>
        <tr>
            <input type="hidden" name="sia_perpanjangan_no_sk" id="sia_perpanjangan_no_sk" value="<?php echo $edit->sia_perpanjangan_no_sk; ?>">
...
<div class="form-group">
    ...
    <div class="col-sm-1" style="padding-top: 3px;">
        ...
        <label>
            <input <?php echo ($edit->sia_perpanjangan_status_perubahan == 1) ? 'checked=""' : ''; ?> type="checkbox" value="1" name="sia_perpanjangan_status_perubahan" class="sia_perpanjangan_status_perubahan" id="sia_perpanjangan_status_perubahan"/> 
        </label>
