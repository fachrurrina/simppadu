...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $edit->sipp_baru_nama_pemilik ?>" type="text" class="form-control input-sm" name="sipp_baru_nama_pemilik" id="sipp_baru_nama_pemilik" />
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $edit->sipp_baru_nama_tempat_praktek ?>" type="text" class="form-control input-sm" name="sipp_baru_nama_tempat_praktek" id="sipp_baru_nama_tempat_praktek" />
    </div>
</div>
