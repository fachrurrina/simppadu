<div class="form-group">
    ...
    <div class="col-sm-3">
        <input readonly="" value="<?php echo $verifikasi->siuakb_baru_nama_perusahaan ?>" type="text" class="form-control input-sm" name="siuakb_baru_nama_perusahaan" id="siuakb_baru_nama_perusahaan" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input readonly="" value="<?php echo $verifikasi->siuakb_baru_nama_pemilik ?>" type="text" class="form-control input-sm" name="siuakb_baru_nama_pemilik" id="siuakb_baru_nama_pemilik" />
    </div>
</div>
...
<div class="form-group" style="margin-bottom: 0">
    ...
    <div class="col-sm-5">
        <input readonly="" value="<?php echo $verifikasi->siuakb_baru_jenis_usaha ?>" type="text" class="form-control input-sm" id="siuakb_baru_jenis_usaha" name="siuakb_baru_jenis_usaha" />
    </div>
