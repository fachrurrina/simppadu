...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input readonly="" value="<?php echo $verifikasi->iup_baru_nama_perusahaan ?>" type="text" class="form-control input-sm" name="iup_baru_nama_perusahaan" id="iup_baru_nama_perusahaan" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input readonly="" value="<?php echo $verifikasi->iup_baru_nama_penanggung_jawab ?>" type="text" class="form-control input-sm" name="iup_baru_nama_penanggung_jawab" id="iup_baru_nama_penanggung_jawab" />
    </div>
</div>
