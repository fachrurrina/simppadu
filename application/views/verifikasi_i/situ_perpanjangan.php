...
<table class="table table-striped table-condensed" id="table_data">
    ...
    <tbody>
        <?php 
        $no_sk = $verifikasi->situ_perpanjangan_no_sk; 
...
<div class="form-group">
    ...
    <div class="col-sm-1" style="padding-top: 3px;">
        ...
        <label>
            <input disabled="" <?php echo ($verifikasi->situ_perpanjangan_status_perubahan == 1) ? 'checked=""' : ''; ?> type="checkbox" value="1" name="situ_perpanjangan_status_perubahan" class="situ_perpanjangan_status_perubahan" id="situ_perpanjangan_status_perubahan"/> 
        </label>
