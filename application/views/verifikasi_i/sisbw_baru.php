...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input readonly="" value="<?php echo $verifikasi->sisbw_baru_nama_pemilik; ?>" type="text" class="form-control input-sm" name="sisbw_baru_nama_pemilik" id="sisbw_baru_nama_pemilik" />
