...
<table class="table table-striped table-condensed" id="table_data">
    ...
    <tbody>
        <?php 
        $no_sk = $verifikasi->sia_perpanjangan_no_sk; 
...
<div class="form-group">
    ...
    <div class="col-sm-1" style="padding-top: 3px;">
        ...
        <label>
            <input disabled="" <?php echo ($verifikasi->sia_perpanjangan_status_perubahan == 1) ? 'checked=""' : ''; ?> type="checkbox" value="1" name="sia_perpanjangan_status_perubahan" class="sia_perpanjangan_status_perubahan" id="sia_perpanjangan_status_perubahan"/> 
        </label>
