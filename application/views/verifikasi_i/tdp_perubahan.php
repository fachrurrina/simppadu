...
<table class="table table-striped table-condensed" id="table_data">
    ...
    <tbody>
        <?php 
        $no_sk = $verifikasi->tdp_perubahan_no_sk; 
...
<div class="form-group" id="alasan_penerbitan" >
    ...
    <div class="col-sm-2" style="padding-top: 3px;">
        ...
        <label>
            <input disabled="" <?php echo ($verifikasi->tdp_perubahan_alasan_penerbitan == 'PL') ? 'checked=""' : '' ; ?> type="radio" name="tdp_perubahan_alasan_penerbitan" value="PL" id="tdp_perubahan_alasan_penerbitan" /> 
            Perubahan Lain-lain
        </label>
    ...
    <div class="col-sm-2" style="padding-top: 3px;">
        ...
        <label>
            <input disabled="" <?php echo ($verifikasi->tdp_perubahan_alasan_penerbitan == 'PS') ? 'checked=""' : '' ; ?> type="radio" name="tdp_perubahan_alasan_penerbitan" value="PS" id="tdp_perubahan_alasan_penerbitan"  /> 
            Perubahan Status 
        </label>
