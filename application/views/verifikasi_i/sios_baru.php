...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input readonly="" value="<?php echo $verifikasi->sios_baru_nama_pemilik ?>" type="text" class="form-control input-sm" name="sios_baru_nama_pemilik" id="sios_baru_nama_pemilik" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input readonly="" value="<?php echo $verifikasi->sios_baru_nama_rumah_sakit ?>" type="text" class="form-control input-sm" name="sios_baru_nama_rumah_sakit" id="sios_baru_nama_rumah_sakit" />
    </div>
</div>
