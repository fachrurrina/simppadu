<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $verifikasi->sipk_baru_nama_kapal ?>" readonly="" type="text" class="form-control input-sm" name="sipk_baru_nama_kapal" id="sipk_baru_nama_kapal" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $verifikasi->sipk_baru_nama_pemilik ?>" readonly="" type="text" class="form-control input-sm" name="sipk_baru_nama_pemilik" id="sipk_baru_nama_pemilik" />
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <?php if($syarat): foreach ($syarat as $r_syarat): ?>
            <label>
                <input readonly="" type="checkbox" name="id_syarat[]" value="<?php echo $r_syarat->id_syarat; ?>" id="id_syarat[]" /> <?php echo $r_syarat->nama_syarat; ?>
            </label>
            <br />
