...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input readonly="" value="<?php echo $verifikasi->sikp_baru_nama_tempat_praktek ?>" type="text" class="form-control input-sm" name="sikp_baru_nama_perusahaan" id="sikp_baru_nama_perusahaan" />
    </div>
</div>
