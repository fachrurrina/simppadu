...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input readonly="" value="<?php echo $verifikasi->sipp_baru_nama_pemilik ?>" type="text" class="form-control input-sm" name="sipp_baru_nama_pemilik" id="sipp_baru_nama_pemilik" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input readonly="" value="<?php echo $verifikasi->sipp_baru_nama_tempat_praktek ?>" type="text" class="form-control input-sm" name="sipp_baru_nama_perusahaan" id="sipp_baru_nama_perusahaan" />
    </div>
</div>
