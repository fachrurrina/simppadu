...
<table class="table table-striped table-condensed" id="table_data">
    ...
    <tbody>
        <?php 
        $no_sk = $verifikasi->siup_perpanjangan_no_sk; 
...
<div class="form-group">
    ...
    <div class="col-sm-1" style="padding-top: 3px;">
        ...
        <label>
            <input disabled="" <?php echo ($verifikasi->siup_perpanjangan_status_perubahan == 1) ? 'checked=""' : ''; ?> type="checkbox" value="1" name="siup_perpanjangan_status_perubahan" class="siup_perpanjangan_status_perubahan" id="siup_perpanjangan_status_perubahan"/> 
        </label>
        
    </div>
</div>

<?php if($verifikasi->siup_perpanjangan_status_perubahan == 1): ?>
<div class="form-group" id="alasan_penerbitan" >
    ...
    <div class="col-sm-2" style="padding-top: 3px;">
        ...
        <label>
            <input disabled="" <?php echo ($verifikasi->siup_perpanjangan_alasan_penerbitan == 'PL') ? 'checked=""' : ''; ?> type="radio" name="siup_perpanjangan_alasan_penerbitan" value="PL" id="siup_perpanjangan_alasan_penerbitan"  /> 
            Perubahan Lain-lain
        </label>
    ...
    <div class="col-sm-2" style="padding-top: 3px;">
        ...
        <label>
            <input disabled="" <?php echo ($verifikasi->siup_perpanjangan_alasan_penerbitan == 'PS') ? 'checked=""' : ''; ?> type="radio" name="siup_perpanjangan_alasan_penerbitan" value="PS" id="siup_perpanjangan_alasan_penerbitan"  /> 
            Perubahan Status 
        </label>
