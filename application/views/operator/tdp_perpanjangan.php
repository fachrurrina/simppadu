...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input <?php // if($fo->tdp_perpanjangan_status_perubahan == 0) { echo ''; } else { if($fo->tdp_perpanjangan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->tdp_perpanjangan_alasan_penerbitan == 'PL') { echo ''; } } ?> value="<?php echo $data_lalu->nama_perusahaan; ?>" type="text" class="form-control input-sm" name="nama_perusahaan" id="nama_perusahaan" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <select <?php // if($fo->tdp_perpanjangan_status_perubahan == 0) { echo ''; } else { if($fo->tdp_perpanjangan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->tdp_perpanjangan_alasan_penerbitan == 'PL') { echo ''; } } ?> class="form-control input-sm" name="status_perusahaan" id="status_perusahaan" >
            <option <?php echo ($data_lalu->status_perusahaan == "Kantor Pusat") ? 'selected=""' : '' ; ?> value="Kantor Pusat">Kantor Pusat</option>
            <option <?php echo ($data_lalu->status_perusahaan == "Kantor Cabang") ? 'selected=""' : '' ; ?> value="Kantor Cabang">Kantor Cabang</option>
        </select>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6"><input <?php // if($fo->tdp_perpanjangan_status_perubahan == 0) { echo ''; } else { if($fo->tdp_perpanjangan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->tdp_perpanjangan_alasan_penerbitan == 'PL') { echo ''; } } ?> value="<?php echo $data_lalu->nama_pemilik ?>" type="text" name="nama_pemilik" id="nama_pemilik" value="<?php echo $data_lalu->nama_pemilik ?>" class="form-control input-sm"></div>
</div>

<div class="form-group">
    <label for="" class="col-sm-2 control-label">No KTP Penanggung Jawab</label>
    <div class="col-sm-6"><input <?php // if($fo->tdp_perpanjangan_status_perubahan == 0) { echo ''; } else { if($fo->tdp_perpanjangan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->tdp_perpanjangan_alasan_penerbitan == 'PL') { echo ''; } } ?> value="<?php echo $data_lalu->no_ktp_pemilik ?>" type="text" name="no_ktp_pemilik" id="no_ktp_pemilik"  class="form-control input-sm"></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <textarea <?php // if($fo->tdp_perpanjangan_status_perubahan == 0) { echo ''; } else { if($fo->tdp_perpanjangan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->tdp_perpanjangan_alasan_penerbitan == 'PL') { echo ''; } } ?> name="alamat_perusahaan" id="alamat_perusahaan" cols="30" rows="2" class="form-control input-sm"><?php echo $data_lalu->alamat_perusahaan; ?></textarea>
    </div>
</div>
    ...
    <div class="col-sm-3">
        <select <?php // if($fo->tdp_perpanjangan_status_perubahan == 0) { echo ''; } else { if($fo->tdp_perpanjangan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->tdp_perpanjangan_alasan_penerbitan == 'PL') { echo ''; } } ?> class="form-control input-sm" name="id_kec_perusahaan" id="id_kec_perusahaan">
            ...
            <?php foreach ($kec as $r_kec): ?>
                <option <?php echo ($data_lalu->id_kec_perusahaan == $r_kec->id_kec) ? 'selected=""' : '' ?> value="<?php echo $r_kec->id_kec; ?>"><?php echo trim($r_kec->nm_kec); ?></option>
            <?php endforeach; ?>
        </select>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select <?php // if($fo->tdp_perpanjangan_status_perubahan == 0) { echo ''; } else { if($fo->tdp_perpanjangan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->tdp_perpanjangan_alasan_penerbitan == 'PL') { echo ''; } } ?> name="id_kel_perusahaan" id="id_kel_perusahaan" class="form-control input-sm">
            <option value=""></option>
            <?php foreach ($kel as $r_kel): ?>
                <option <?php echo ($data_lalu->id_kel_perusahaan == $r_kel->id_kel) ? 'selected=""' : '' ?> value="<?php echo $r_kel->id_kel; ?>"><?php echo trim($r_kel->nm_kel); ?></option>
            <?php endforeach; ?>
        </select>
...
<div class="form-group">
    ...
    <div class="col-sm-3"><input <?php // if($fo->tdp_perpanjangan_status_perubahan == 0) { echo ''; } else { if($fo->tdp_perpanjangan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->tdp_perpanjangan_alasan_penerbitan == 'PL') { echo ''; } } ?> value="<?php echo $data_lalu->nilai_investasi ?>" type="number" step="50000" name="nilai_investasi" id="nilai_investasi"  class="form-control input-sm"></div>
    <script type="text/javascript">
        $('#nilai_investasi').change(function(){
            $('#ket_status_modal_baru').val(get_status_modal_perusahaan($(this).val()));
        });
    </script>
    <div class="col-sm-1"><input   value="<?php echo get_status_modal_perusahaan($data_lalu->nilai_investasi); ?>" value="<?php echo get_status_modal_perusahaan($data_lalu->nilai_investasi) ?>" type="text" class="form-control input-sm" name="ket_status_modal" id="ket_status_modal"></div>
    ...
    <div class="col-sm-1"><input <?php // if($fo->tdp_perpanjangan_status_perubahan == 0) { echo ''; } else { if($fo->tdp_perpanjangan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->tdp_perpanjangan_alasan_penerbitan == 'PL') { echo ''; } } ?> value="<?php echo get_status_modal_perusahaan($data_lalu->nilai_investasi); ?>" type="text" class="form-control input-sm" name="ket_status_modal_baru" id="ket_status_modal_baru"></div>
    <?php endif; endif; ?>
...
<div class="form-group">
    ...
    <div class="col-sm-6"><input <?php // if($fo->tdp_perpanjangan_status_perubahan == 0) { echo ''; } else { if($fo->tdp_perpanjangan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->tdp_perpanjangan_alasan_penerbitan == 'PL') { echo ''; } } ?> value="<?php echo $data_lalu->npwp ?>" type="text" name="npwp" id="npwp" class="form-control input-sm"></div>
</div>

<div class="form-group">
    <label for="" class="col-sm-2 control-label">No Telepon</label>
    <div class="col-sm-6"><input <?php // if($fo->tdp_perpanjangan_status_perubahan == 0) { echo ''; } else { if($fo->tdp_perpanjangan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->tdp_perpanjangan_alasan_penerbitan == 'PL') { echo ''; } } ?> value="<?php echo $data_lalu->no_telp ?>" type="text" name="no_telp" id="no_telp" class="form-control input-sm"></div>
</div>

<div class="form-group">
    <label for="" class="col-sm-2 control-label">No Fax</label>
    <div class="col-sm-6"><input <?php // if($fo->tdp_perpanjangan_status_perubahan == 0) { echo ''; } else { if($fo->tdp_perpanjangan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->tdp_perpanjangan_alasan_penerbitan == 'PL') { echo ''; } } ?> value="<?php echo $data_lalu->no_fax; ?>" type="text" name="no_fax" id="no_fax" class="form-control input-sm"></div>
</div>

<div class="form-group">
    <label for="" class="col-sm-2 control-label">No Akte Notaris</label>
    <div class="col-sm-6"><input <?php // if($fo->tdp_perpanjangan_status_perubahan == 0) { echo ''; } else { if($fo->tdp_perpanjangan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->tdp_perpanjangan_alasan_penerbitan == 'PL') { echo ''; } } ?> value="<?php echo $data_lalu->no_akte_notaris; ?>" type="text" name="no_akte_notaris" id="no_akte_notaris" class="form-control input-sm"></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        ...
        <ul>
                ...
                <li class="control-label" style="text-align: left;"><?php echo $data_baru->id_kbli; ?> : <?php echo $this->m_kbli->get_judul_kbli($data_baru->id_kbli); ?></li>
