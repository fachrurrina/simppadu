...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $data_lalu->no_sipa ?>" type="text" class="form-control input-sm" name="no_sipa" id="no_sipa" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $data_lalu->nama_apotek; ?>" type="text" class="form-control input-sm" name="nama_apotek" id="nama_apotek" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6"><textarea name="alamat_apotek" id="alamat_apotek" class="form-control input-sm"><?php echo $data_lalu->alamat_apotek ?></textarea></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select name="id_kec_apotek" id="id_kec_apotek" class="form-control input-sm">
            <option value=""></option>
            <?php foreach ($kec as $r_kec): ?>
                <option <?php echo ($data_lalu->id_kec_apotek == $r_kec->id_kec) ? 'selected=""' : '' ?> value="<?php echo $r_kec->id_kec; ?>"><?php echo $r_kec->nm_kec; ?></option>
            <?php endforeach; ?>
        </select>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select name="id_kel_apotek" id="id_kel_apotek" class="form-control input-sm">
            <option value=""></option>
            <?php foreach ($kel as $r_kel): ?>
                <option <?php echo ($data_lalu->id_kel_apotek == $r_kel->id_kel) ? 'selected=""' : '' ?> value="<?php echo $r_kel->id_kel; ?>"><?php echo $r_kel->nm_kel; ?></option>
            <?php endforeach; ?>
        </select>
        <p class="help-block">Jika ada kecamatan atau gampong yang belum tersedia, silahkan hubungi administrator untuk menambahkan</p>
    </div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $data_lalu->nama_pemilik_sarana ?>" type="text" class="form-control input-sm" name="nama_pemilik_sarana" id="nama_pemilik_sarana" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6"><textarea name="alamat_pemilik_sarana" id="alamat_pemilik_sarana" class="form-control input-sm"><?php echo $data_lalu->alamat_pemilik_sarana ?></textarea></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select name="id_kec_pemilik_sarana" id="id_kec_pemilik_sarana" class="form-control input-sm">
            <option value=""></option>
            <?php foreach ($kec as $r_kec): ?>
                <option <?php echo ($data_lalu->id_kec_pemilik_sarana == $r_kec->id_kec) ? 'selected=""' : '' ?> value="<?php echo $r_kec->id_kec; ?>"><?php echo $r_kec->nm_kec; ?></option>
            <?php endforeach; ?>
        </select>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select name="id_kel_pemilik_sarana" id="id_kel_pemilik_sarana" class="form-control input-sm">
            <option value=""></option>
            <?php foreach ($kel as $r_kel): ?>
                <option <?php echo ($data_lalu->id_kel_pemilik_sarana == $r_kel->id_kel) ? 'selected=""' : '' ?> value="<?php echo $r_kel->id_kel; ?>"><?php echo $r_kel->nm_kel; ?></option>
            <?php endforeach; ?>
        </select>
        <p class="help-block">Jika ada kecamatan atau gampong yang belum tersedia, silahkan hubungi administrator untuk menambahkan</p>
    </div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $data_lalu->no_akte_perjanjian ?>" type="text" class="form-control input-sm" name="no_akte_perjanjian" id="no_akte_perjanjian" />
    </div>
</div>

<div class="form-group">
    <label for="" class="col-sm-2 control-label">Tanggal Akte Perjanjian Kerjasama</label>
    <div class="col-sm-4"><input value="<?php echo $data_lalu->tanggal_akte_perjanjian ?>" type="date" name="tanggal_akte_perjanjian" id="tanggal_akte_perjanjian" class="form-control input-sm"></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $data_lalu->nama_notaris_akte_perjanjian ?>" type="text" class="form-control input-sm" name="nama_notaris_akte_perjanjian" id="nama_notaris_akte_perjanjian" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $data_lalu->tempat_akte_perjanjian ?>" type="text" class="form-control input-sm" name="tempat_akte_perjanjian" id="tempat_akte_perjanjian" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-4"><input readonly="" value="<?php echo $data_baru->tanggal_daftar_ulang ?>" type="date" name="tanggal_daftar_ulang" id="tanggal_daftar_ulang" class="form-control input-sm"></div>
</div>
