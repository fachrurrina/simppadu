...
<div class="form-group">
    ...
    <div class="col-sm-6"><textarea name="alamat_pemilik" id="alamat_pemilik" class="form-control input-sm"><?php echo $fo->ho_baru_alamat_pemilik; ?></textarea></div>
</div>
    ...
    <div class="col-sm-4">
        <select name="id_kec_pemilik" id="id_kec_pemilik" class="form-control input-sm">
            ...
            <?php foreach ($kec as $r_kec): ?>
                <option <?php echo ($fo->ho_baru_id_kec_pemilik == $r_kec->id_kec) ? 'selected=""' : ''; ?> value="<?php echo $r_kec->id_kec; ?>"><?php echo $r_kec->nm_kec; ?></option>
            <?php endforeach; ?>
        </select>
    </div>
</div>
    ...
    <div class="col-sm-4">
        <select name="id_kel_pemilik" id="id_kel_pemilik" class="form-control input-sm">
            ...
            <?php foreach ($kel as $r_kel): ?>
                <option <?php echo ($fo->ho_baru_id_kel_pemilik == $r_kel->id_kel) ? 'selected=""' : ''; ?> value="<?php echo $r_kel->id_kel; ?>"><?php echo $r_kel->nm_kel; ?></option>
            <?php endforeach; ?>
        </select>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        ...
        <table class="table" style="margin-bottom: 2px;" id="table-luas">
            <tbody>
                <?php  
                $array_ket_luas_tempat_usaha = explode('|', $fo->ho_baru_ket_luas_tempat_usaha);
                $array_panjang_tempat_usaha = explode('|', $fo->ho_baru_panjang_tempat_usaha);
                $array_lebar_tempat_usaha   = explode('|', $fo->ho_baru_lebar_tempat_usaha);
...
<?php if($fo->ho_baru_tinggi_tower > 0): ?>
    <div class="form-group">
        <label for="inputEmail3" class="col-sm-2 control-label">Tinggi Tower</label>
        <div class="col-sm-4">
            <input readonly=""  value="<?php echo $fo->ho_baru_tinggi_tower ?>" type="number" class="form-control input-sm" name="ho_baru_tinggi_tower" id="ho_baru_tinggi_tower">
        </div>
    </div>
<?php endif; ?>
    ...
    <div class="col-sm-4">
        ...
        <select readonly="" class="form-control input-sm" name="ho_baru_kode_index_gangguan" id="ho_baru_kode_index_gangguan">
            ...
            <?php if($index_gangguan): foreach($index_gangguan as $r_index_gangguan): ?>
                <option <?php echo ($fo->ho_baru_kode_index_gangguan == $r_index_gangguan->kode_index_gangguan) ? 'selected=""' : '' ?> value="<?php echo $r_index_gangguan->kode_index_gangguan ?>" nilai_index_gangguan="<?php echo $r_index_gangguan->nilai_index_gangguan; ?>"><?php echo $r_index_gangguan->nama_index_gangguan ?></option>
            <?php endforeach; endif; ?>
        </select>
...
<input value="<?php echo $fo->ho_baru_tinggi_tower ?>" type="hidden" name="tinggi_tower" id="tinggi_tower" >
<input value="<?php echo $fo->ho_baru_ket_luas_tempat_usaha ?>" type="hidden" name="ket_luas_tempat_usaha" id="ket_luas_tempat_usaha" >
<input value="<?php echo $fo->ho_baru_panjang_tempat_usaha ?>" type="hidden" name="panjang_tempat_usaha" id="panjang_tempat_usaha" >
<input value="<?php echo $fo->ho_baru_lebar_tempat_usaha ?>" type="hidden" name="lebar_tempat_usaha" id="lebar_tempat_usaha" >
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <input value="" type="text" class="form-control input-sm" name="no_surat_ket_usaha" id="no_surat_ket_usaha" />
    </div>
</div>

<div class="form-group">
    <label for="" class="col-sm-2 control-label">Tanggal Surat Keterangan Usaha</label>
    <div class="col-sm-6"><input value="" type="date" name="tanggal_surat_ket_usaha" id="tanggal_surat_ket_usaha" class="form-control input-sm"></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6"><input value="" type="date" name="tanggal_surat_pernyataan_lingkungan" id="tanggal_surat_pernyataan_lingkungan" class="form-control input-sm"></div>
</div>
