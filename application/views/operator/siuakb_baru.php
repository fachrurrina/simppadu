...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $fo->siuakb_baru_nama_pemilik; ?>" type="text" class="form-control input-sm" name="nama_pemilik" id="nama_pemilik" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $fo->siuakb_baru_nama_perusahaan; ?>" type="text" class="form-control input-sm" name="nama_perusahaan" id="nama_perusahaan" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <input value="" type="text" class="form-control input-sm" name="jenis_usaha" id="jenis_usaha" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="" type="number" class="form-control input-sm" name="jumlah_kendaraan" id="jumlah_kendaraan" />
    </div>
</div>
