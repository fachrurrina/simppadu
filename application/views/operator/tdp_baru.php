...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $fo->tdp_baru_nama_perusahaan; ?>" type="text" class="form-control input-sm" name="nama_perusahaan" id="nama_perusahaan" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        ...
        <?php if($bentuk_perusahaan): foreach($bentuk_perusahaan as $r_bentuk_perusahaan): ?>
        	<option <?php echo ($fo->tdp_baru_id_bentuk_perusahaan == $r_bentuk_perusahaan->id_bentuk_perusahaan) ? 'selected=""' : '' ; ?> value="<?php echo $r_bentuk_perusahaan->id_bentuk_perusahaan ?>"><?php echo $r_bentuk_perusahaan->nama_bentuk_perusahaan ?></option>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <select class="form-control input-sm" name="status_perusahaan" id="status_perusahaan" >
        	<option <?php echo ($fo->tdp_baru_status_perusahaan == "Kantor Pusat") ? 'selected=""' : '' ; ?> value="Kantor Pusat">Kantor Pusat</option>
        	<option <?php echo ($fo->tdp_baru_status_perusahaan == "Kantor Cabang") ? 'selected=""' : '' ; ?> value="Kantor Cabang">Kantor Cabang</option>
        </select>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6"><input type="text" name="nama_pemilik" id="nama_pemilik" value="<?php echo $fo->tdp_baru_nama_pemilik ?>" class="form-control input-sm"></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <textarea name="alamat_perusahaan" id="alamat_perusahaan" cols="30" rows="2" class="form-control input-sm"></textarea>
    </div>
</div>
    ...
    <div class="col-sm-4">
        <select class="form-control input-sm" name="id_kec_perusahaan" id="id_kec_perusahaan">
            ...
            <?php foreach ($kec as $r_kec): ?>
                <option value="<?php echo $r_kec->id_kec; ?>"><?php echo trim($r_kec->nm_kec); ?></option>
            <?php endforeach; ?>
        </select>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3"><input type="number" name="nilai_investasi" id="nilai_investasi"  class="form-control input-sm"></div>
    <script type="text/javascript">
...
<div class="form-group">
    ...
    <div class="col-sm-6"><input type="text" name="npwp" id="npwp" class="form-control input-sm"></div>
</div>

<div class="form-group">
    <label for="" class="col-sm-2 control-label">No Telepon</label>
    <div class="col-sm-6"><input type="text" name="no_telp" id="no_telp" class="form-control input-sm"></div>
</div>

<div class="form-group">
    <label for="" class="col-sm-2 control-label">No Fax</label>
    <div class="col-sm-6"><input type="text" name="no_fax" id="no_fax" class="form-control input-sm"></div>
</div>

<div class="form-group">
    <label for="" class="col-sm-2 control-label">No Akte Notaris</label>
    <div class="col-sm-6"><input type="text" name="no_akte_notaris" id="no_akte_notaris" class="form-control input-sm"></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        ...
        <ul>
                ...
                <li class="control-label" style="text-align: left;"><?php echo $agenda->id_kbli; ?> : <?php echo $this->m_kbli->get_judul_kbli($agenda->id_kbli); ?></li>
...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <input readonly="" value="<?php echo $agenda->tanggal_terbit ?>" type="date" name="tanggal_terbit" id="tanggal_terbit" class="form-control input-sm">
    </div>
</div>
<div class="form-group">
    <label for="" class="col-sm-2 control-label">Tanggal berlaku</label>
    <div class="col-sm-6">
        <input readonly="" value="<?php echo $agenda->tanggal_perpanjangan ?>" type="date" name="tanggal_perpanjangan" id="tanggal_perpanjangan" class="form-control input-sm">
    </div>
</div>