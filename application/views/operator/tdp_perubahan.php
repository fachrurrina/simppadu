...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input <?php // if($fo->tdp_perubahan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->tdp_perubahan_alasan_penerbitan == 'PL') { echo ''; } ?> value="<?php echo $data_lalu->nama_perusahaan; ?>" type="text" class="form-control input-sm" name="nama_perusahaan" id="nama_perusahaan" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6"><input <?php // if($fo->tdp_perubahan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->tdp_perubahan_alasan_penerbitan == 'PL') { echo ''; } ?> value="<?php echo $data_lalu->nama_pemilik ?>" type="text" name="nama_pemilik" id="nama_pemilik" value="<?php echo $data_lalu->nama_pemilik ?>" class="form-control input-sm"></div>
</div>

<div class="form-group">
    <label for="" class="col-sm-2 control-label">No KTP Penanggung Jawab</label>
    <div class="col-sm-6"><input <?php // if($fo->tdp_perubahan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->tdp_perubahan_alasan_penerbitan == 'PL') { echo ''; } ?> value="<?php echo $data_lalu->no_ktp_pemilik ?>" type="text" name="no_ktp_pemilik" id="no_ktp_pemilik"  class="form-control input-sm"></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <textarea <?php // if($fo->tdp_perubahan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->tdp_perubahan_alasan_penerbitan == 'PL') { echo ''; } ?> name="alamat_perusahaan" id="alamat_perusahaan" cols="30" rows="2" class="form-control input-sm"><?php echo $data_lalu->alamat_perusahaan; ?></textarea>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3"><input <?php // if($fo->tdp_perubahan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->tdp_perubahan_alasan_penerbitan == 'PL') { echo 'readonly=""'; } ?> value="<?php echo $data_lalu->nilai_investasi ?>" type="number" step="50000" name="nilai_investasi" id="nilai_investasi"  class="form-control input-sm"></div>
    <script type="text/javascript">
        $('#nilai_investasi').change(function(){
            $('#ket_status_modal_baru').val(get_status_modal_perusahaan($(this).val()));
        });
    </script>
    <div class="col-sm-1"><input readonly=""  value="<?php echo get_status_modal_perusahaan($data_lalu->nilai_investasi); ?>" value="<?php echo get_status_modal_perusahaan($data_lalu->nilai_investasi) ?>" type="text" class="form-control input-sm" name="ket_status_modal" id="ket_status_modal"></div>
    
    

    <?php if($fo->tdp_perubahan_alasan_penerbitan == 'PS'): ?>
        <div class="col-sm-1"><label for="">Berubah ke</label></div>
        <div class="col-sm-1"><input <?php // if($fo->tdp_perubahan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->tdp_perubahan_alasan_penerbitan == 'PL') { echo 'readonly=""'; } ?> value="<?php echo get_status_modal_perusahaan($data_lalu->nilai_investasi); ?>" type="text" class="form-control input-sm" name="ket_status_modal_baru" id="ket_status_modal_baru"></div>
    <?php endif; ?>
...
<div class="form-group">
    ...
    <div class="col-sm-6"><input <?php // if($fo->tdp_perubahan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->tdp_perubahan_alasan_penerbitan == 'PL') { echo ''; } ?> value="<?php echo $data_lalu->npwp ?>" type="text" name="npwp" id="npwp" class="form-control input-sm"></div>
</div>

<div class="form-group">
    <label for="" class="col-sm-2 control-label">No Telepon</label>
    <div class="col-sm-6"><input <?php // if($fo->tdp_perubahan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->tdp_perubahan_alasan_penerbitan == 'PL') { echo ''; } ?> value="<?php echo $data_lalu->no_telp ?>" type="text" name="no_telp" id="no_telp" class="form-control input-sm"></div>
</div>

<div class="form-group">
    <label for="" class="col-sm-2 control-label">No Fax</label>
    <div class="col-sm-6"><input <?php // if($fo->tdp_perubahan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->tdp_perubahan_alasan_penerbitan == 'PL') { echo ''; } ?> value="<?php echo $data_lalu->no_fax; ?>" type="text" name="no_fax" id="no_fax" class="form-control input-sm"></div>
</div>

<div class="form-group">
    <label for="" class="col-sm-2 control-label">No Akte Notaris</label>
    <div class="col-sm-6"><input <?php // if($fo->tdp_perubahan_alasan_penerbitan == 'PS') { echo ''; } elseif($fo->tdp_perubahan_alasan_penerbitan == 'PL') { echo ''; } ?> value="<?php echo $data_lalu->no_akte_notaris; ?>" type="text" name="no_akte_notaris" id="no_akte_notaris" class="form-control input-sm"></div>
</div>
