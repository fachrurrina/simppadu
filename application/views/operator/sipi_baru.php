...
<div class="form-group">
    ...
    <div class="col-sm-6"><input value="<?php echo $fo->sipi_baru_nama; ?>" type="text" name="nama" id="nama" class="form-control input-sm"></div>
</div>


<div class="form-group">
    <label for="" class="col-sm-2 control-label">Alamat </label>
    <div class="col-sm-6"><textarea name="alamat" id="alamat" class="form-control input-sm"><?php echo $fo->sipi_baru_alamat; ?></textarea></div>
</div>
    ...
    <div class="col-sm-4">
        <select name="id_kec" id="id_kec" class="form-control input-sm">
            ...
            <?php foreach ($kec as $r_kec): ?>
                <option <?php echo ($fo->sipi_baru_id_kec == $r_kec->id_kec) ? 'selected=""' : ''; ?> value="<?php echo $r_kec->id_kec; ?>"><?php echo $r_kec->nm_kec; ?></option>
            <?php endforeach; ?>
        </select>
    </div>
</div>
    ...
    <div class="col-sm-4">
        <select name="id_kel" id="id_kel" class="form-control input-sm">
            ...
            <?php foreach ($kel as $r_kel): ?>
                <option <?php echo ($fo->sipi_baru_id_kel == $r_kel->id_kel) ? 'selected=""' : ''; ?> value="<?php echo $r_kel->id_kel; ?>"><?php echo $r_kel->nm_kel; ?></option>
            <?php endforeach; ?>
        </select>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="" type="text" class="form-control input-sm" name="no_ktp" id="no_ktp" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $fo->sipi_baru_nama_kapal ?>" type="text" class="form-control input-sm" name="nama_kapal" id="nama_kapal" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="" type="text" class="form-control input-sm" name="tempat_reg_kapal" id="tempat_reg_kapal" />
    </div>
    <div class="col-sm-3">
        <input value="" type="text" class="form-control input-sm" name="no_reg_kapal" id="no_reg_kapal" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="" type="text" class="form-control input-sm" name="tempat_gelar_kapal" id="tempat_gelar_kapal" />
    </div>
    <div class="col-sm-3">
        <input value="" type="text" class="form-control input-sm" name="tanda_gelar_kapal" id="tanda_gelar_kapal" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-5">
        <input value="" type="text" class="form-control input-sm" name="nama_panggilan_kapal" id="nama_panggilan_kapal" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-5">
        <input value="" type="text" class="form-control input-sm" name="asal_kapal" id="asal_kapal" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-5">
        <input value="" type="text" class="form-control input-sm" name="negara_asal_kapal" id="negara_asal_kapal" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-5">
        <input value="" type="text" class="form-control input-sm" name="tempat_pembuatan_kapal" id="tempat_pembuatan_kapal" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-5">
        <input value="" type="text" class="form-control input-sm" name="jenis_kapal" id="jenis_kapal" />
    </div>
</div>
    ...
    <div class="col-sm-5">
        <select readonly="" class="form-control input-sm" name="id_jenis_alat_tangkap" id="id_jenis_alat_tangkap" >
            ...
            <?php if($jenis_alat_tangkap): foreach($jenis_alat_tangkap as $r_jenis_alat_tangkap): ?>
                <option <?php echo ($fo->sipi_baru_id_jenis_alat_tangkap == $r_jenis_alat_tangkap->id_jenis_alat_tangkap) ? 'selected=""' : ''; ?> value="<?php echo $r_jenis_alat_tangkap->id_jenis_alat_tangkap ?>"><?php echo $r_jenis_alat_tangkap->nama_jenis_alat_tangkap ?></option>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="" type="text" class="form-control input-sm" name="tonase_kotor" id="tonase_kotor" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="" type="text" class="form-control input-sm" name="tonase_bersih" id="tonase_bersih" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="" type="text" class="form-control input-sm" name="kekuatan_mesin" id="kekuatan_mesin" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-5">
        <input value="" type="text" class="form-control input-sm" name="merek_mesin" id="merek_mesin" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-5">
        <input value="" type="text" class="form-control input-sm" name="no_seri_mesin" id="no_seri_mesin" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-5">
        <input value="" type="text" class="form-control input-sm" name="bahan_kasco" id="bahan_kasco" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-5">
        <input value="" type="text" class="form-control input-sm" name="no_iup" id="no_iup" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-5">
        <input value="" type="date" class="form-control input-sm" name="tanggal_iup" id="tanggal_iup" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-5">
        <input value="" type="text" class="form-control input-sm" name="no_permohonan_iup" id="no_permohonan_iup" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-5">
        <input value="" type="date" class="form-control input-sm" name="tanggal_permohonan_iup" id="tanggal_permohonan_iup" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6"><textarea name="daerah_penangkapan" id="daerah_penangkapan" class="form-control input-sm"></textarea></div>
</div>


<div class="form-group">
    <label for="" class="col-sm-2 control-label">Daerah Penangkapan Terlarang</label>
    <div class="col-sm-6"><textarea name="daerah_terlarang" id="daerah_terlarang" class="form-control input-sm"></textarea></div>
</div>


<div class="form-group">
    <label for="" class="col-sm-2 control-label">Pelabuhan Penangkalan</label>
    <div class="col-sm-6"><textarea name="pelabuhan_penangkalan" id="pelabuhan_penangkalan" class="form-control input-sm"></textarea></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-5">
        <input value="" type="number" class="form-control input-sm" name="anak_buah_kapal" id="anak_buah_kapal" />
    </div>
</div>

<input type="hidden" name="nilai_retribusi" id="nilai_retribusi" value="<?php echo $fo->sipi_baru_nilai_retribusi ?>">
...
<div class="form-group">
    ...
    <div class="col-sm-6"><input readonly="" value="<?php echo $fo->sipi_baru_tanggal_peninjauan_lapangan ?>" type="date" name="tanggal_peninjauan_lapangan" id="tanggal_peninjauan_lapangan" class="form-control input-sm"></div>
</div>
