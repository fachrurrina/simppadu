...
<div class="form-group">
    ...
    <div class="col-sm-6"><input value="<?php echo $fo->siup_baru_nama_perusahaan; ?>" type="text" name="nama_perusahaan" id="nama_perusahaan" class="form-control input-sm"></div>
</div>
    ...
    <div class="col-sm-3">
        <select class="form-control input-sm" name="id_bentuk_perusahaan" id="id_bentuk_perusahaan">
            ...
            <?php if($bentuk_perusahaan): foreach($bentuk_perusahaan as $r_bentuk_perusahaan): ?>
                <option <?php echo ($fo->siup_baru_id_bentuk_perusahaan == $r_bentuk_perusahaan->id_bentuk_perusahaan) ? 'selected=""' : '' ; ?> value="<?php echo $r_bentuk_perusahaan->id_bentuk_perusahaan ?>"><?php echo $r_bentuk_perusahaan->nama_bentuk_perusahaan ?></option>
...
<div class="form-group">
    ...
    <div class="col-sm-6"><input value="<?php echo $fo->siup_baru_nama_pemilik; ?>" type="text" name="nama_pemilik" id="nama_penanggung_jawab" class="form-control input-sm"></div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-sm-6"><input type="text" name="jabatan_pemilik" id="jabatan_pemilik" class="form-control input-sm"></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3"><input type="number" name="modal_perusahaan" id="modal_perusahaan" value="" class="form-control input-sm"></div>
...
<div class="form-group">
    ...
    <div class="col-sm-2">
        <input value="0" type="number" name="tenaga_kerja_a" id="tenaga_kerja_a" class="form-control input-sm">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-2">
        <input value="0" type="number" name="tenaga_kerja_b" id="tenaga_kerja_b" class="form-control input-sm">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-2">
        <input value="0" type="number" name="tenaga_kerja_c" id="tenaga_kerja_c" class="form-control input-sm">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-2">
        <input value="0" type="number" name="tenaga_kerja_d" id="tenaga_kerja_d" class="form-control input-sm">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <ul>
            <?php  
            $array_kbli_4 = explode('|', $agenda->id_kbli);
            ?>
