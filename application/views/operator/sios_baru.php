...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $fo->sios_baru_nama_rumah_sakit; ?>" type="text" class="form-control input-sm" name="nama_rumah_sakit" id="nama_rumah_sakit" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $fo->sios_baru_nama_pemilik; ?>" type="text" class="form-control input-sm" name="nama_pemilik" id="nama_pemilik" />
    </div>
</div>
