...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="" type="text" class="form-control input-sm" name="no_surat_dirjen_buk" id="no_surat_dirjen_buk" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="" type="date" class="form-control input-sm" name="tanggal_surat_dirjen_buk" id="tanggal_surat_dirjen_buk" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $fo->siot_baru_nama_rumah_sakit; ?>" type="text" class="form-control input-sm" name="nama_rumah_sakit" id="nama_rumah_sakit" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="" type="text" class="form-control input-sm" name="klasifikasi_kelas_menkes" id="klasifikasi_kelas_menkes" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6"><textarea name="alamat_rumah_sakit" id="alamat_rumah_sakit" class="form-control input-sm"></textarea></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $fo->siot_baru_nama_pemilik; ?>" type="text" class="form-control input-sm" name="nama_pemilik" id="nama_pemilik" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="" type="text" class="form-control input-sm" name="dokter_penanggung_jawab" id="dokter_penanggung_jawab" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="" type="text" class="form-control input-sm" name="no_sip_dokter" id="no_sip_dokter" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="" type="date" class="form-control input-sm" name="tanggal_berlaku_sip" id="tanggal_berlaku_sip" />
    </div>
</div>
