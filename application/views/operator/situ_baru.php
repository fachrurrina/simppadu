...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $fo->situ_baru_nama_pemilik; ?>" type="text" class="form-control input-sm" name="nama_pemilik" id="nama_pemilik" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <input value="<?php echo $fo->situ_baru_nama_perusahaan; ?>" type="text" class="form-control input-sm" name="nama_perusahaan" id="nama_perusahaan" />
    </div>
</div>
    ...
    <div class="col-sm-3">
        <select class="form-control input-sm" name="id_bentuk_perusahaan" id="id_bentuk_perusahaan">
            ...
            <?php if($bentuk_perusahaan): foreach($bentuk_perusahaan as $r_bentuk_perusahaan): ?>
                <option <?php echo ($fo->situ_baru_id_bentuk_perusahaan == $r_bentuk_perusahaan->id_bentuk_perusahaan) ? 'selected=""' : ''; ?> value="<?php echo $r_bentuk_perusahaan->id_bentuk_perusahaan ?>"><?php echo $r_bentuk_perusahaan->nama_bentuk_perusahaan ?></option>
...
<div class="form-group">
    ...
    <div class="col-sm-2">
        <input value="0" type="number" step="any" class="form-control input-sm" name="panjang_tempat_usaha" id="panjang_tempat_usaha" />
    </div>
    <label for="inputEmail3" class="col-sm-1 control-label" style="text-align: center;">x</label>
    <div class="col-sm-2">
        <input value="0" type="number" step="any" class="form-control input-sm" name="lebar_tempat_usaha" id="lebar_tempat_usaha" />
    </div>
    ...
    <div class="col-sm-2">
        <input value="0" type="number" step="any" class="form-control input-sm" name="luas_tempat_usaha" id="luas_tempat_usaha" />
    </div>
...
<div class="form-group" style="margin-bottom: 0">
    ...
    <div class="col-sm-1" style="text-align: right">
        <label>
            <input checked="" type="radio" name="metode_input_bidang_situ" value="pilihan" class="metode_input_bidang_situ" /> Pilihan
        </label>
    </div>

    <div class="col-sm-1" style="text-align: right">
        <label>
            <input type="radio" name="metode_input_bidang_situ" value="manual" class="metode_input_bidang_situ" /> Manual
        </label>
    </div>
    ...
    <div class="col-sm-4">
        ...
        <select class="form-control input-sm" id="nama_bidang_situ_pilihan">
            ...
            <?php if($bidang_situ): foreach($bidang_situ as $r_bidang_situ): ?>
                <option value="<?php echo $r_bidang_situ->nama_bidang_situ ?>"><?php echo $r_bidang_situ->nama_bidang_situ ?></option>
            <?php endforeach; endif; ?>
        </select>
        
        <!-- pilihan text manual -->
        <input value="" type="text" class="form-control input-sm" id="nama_bidang_situ_manual" />
    </div>
