...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $fo->ho_perpanjangan_nama_pemilik; ?>" type="text" class="form-control input-sm" name="nama_pemilik" id="nama_pemilik" />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-3">
        <input value="<?php echo $fo->ho_perpanjangan_nama_perusahaan; ?>" type="text" class="form-control input-sm" name="nama_perusahaan" id="nama_perusahaan" />
    </div>
</div>
    ...
    <div class="col-sm-3">
        <select class="form-control input-sm" name="id_bentuk_perusahaan" id="id_bentuk_perusahaan">
            ...
            <?php if($bentuk_perusahaan): foreach($bentuk_perusahaan as $r_bentuk_perusahaan): ?>
                <option <?php echo ($fo->ho_perpanjangan_id_bentuk_perusahaan == $r_bentuk_perusahaan->id_bentuk_perusahaan) ? 'selected=""' : ''; ?> value="<?php echo $r_bentuk_perusahaan->id_bentuk_perusahaan ?>"><?php echo $r_bentuk_perusahaan->nama_bentuk_perusahaan ?></option>
...
<div class="form-group">
    ...
    <div class="col-sm-7">
        <input value="<?php echo $fo->ho_perpanjangan_nama_bidang_usaha ?>" type="text" class="form-control input-sm" name="nama_bidang_usaha" id="nama_bidang_usaha">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-6"><textarea name="alamat_perusahaan" id="alamat_perusahaan" class="form-control input-sm"><?php echo $fo->ho_perpanjangan_alamat_perusahaan; ?></textarea></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select name="id_kec_perusahaan" id="id_kec_perusahaan" class="form-control input-sm">
            <option value=""></option>
            <?php foreach ($kec as $r_kec): ?>
                <option <?php echo ($fo->ho_perpanjangan_id_kec_perusahaan == $r_kec->id_kec) ? 'selected=""' : ''; ?> value="<?php echo $r_kec->id_kec; ?>"><?php echo $r_kec->nm_kec; ?></option>
            <?php endforeach; ?>
        </select>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <select name="id_kel_perusahaan" id="id_kel_perusahaan" class="form-control input-sm">
            <option value=""></option>
            <?php foreach ($kel as $r_kel): ?>
                <option <?php echo ($fo->ho_perpanjangan_id_kel_perusahaan == $r_kel->id_kel) ? 'selected=""' : ''; ?> value="<?php echo $r_kel->id_kel; ?>"><?php echo $r_kel->nm_kel; ?></option>
            <?php endforeach; ?>
        </select>
        <p class="help-block">Jika ada kecamatan atau gampong yang belum tersedia, silahkan hubungi administrator untuk menambahkan</p>
    </div>
...
<div class="form-group">
    ...
    <div class="col-sm-6"><input readonly="" value="<?php echo $fo->ho_perpanjangan_tanggal_peninjauan_lapangan ?>" type="date" name="tanggal_peninjauan_lapangan" id="tanggal_peninjauan_lapangan" class="form-control input-sm"></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        ...
        <table class="table" style="margin-bottom: 2px;" id="table-luas">
            <tbody>
                <?php  
                $array_ket_luas_tempat_usaha = explode('|', $fo->ho_perpanjangan_ket_luas_tempat_usaha);
                $array_panjang_tempat_usaha = explode('|', $fo->ho_perpanjangan_panjang_tempat_usaha);
                $array_lebar_tempat_usaha   = explode('|', $fo->ho_perpanjangan_lebar_tempat_usaha);
...
<?php if($fo->ho_perpanjangan_tinggi_tower > 0): ?>
    <div class="form-group">
        <label for="inputEmail3" class="col-sm-2 control-label">Tinggi Tower</label>
        <div class="col-sm-4">
            <input readonly=""  value="<?php echo $fo->ho_perpanjangan_tinggi_tower ?>" type="number" class="form-control input-sm" name="ho_perpanjangan_tinggi_tower" id="ho_perpanjangan_tinggi_tower">
        </div>
    </div>
<?php endif; ?>
    ...
    <div class="col-sm-4">
        ...
        <select readonly="" class="form-control input-sm" name="ho_perpanjangan_kode_index_gangguan" id="ho_perpanjangan_kode_index_gangguan">
            ...
            <?php if($index_gangguan): foreach($index_gangguan as $r_index_gangguan): ?>
                <option <?php echo ($fo->ho_perpanjangan_kode_index_gangguan == $r_index_gangguan->kode_index_gangguan) ? 'selected=""' : '' ?> value="<?php echo $r_index_gangguan->kode_index_gangguan ?>" nilai_index_gangguan="<?php echo $r_index_gangguan->nilai_index_gangguan; ?>"><?php echo $r_index_gangguan->nama_index_gangguan ?></option>
            <?php endforeach; endif; ?>
        </select>
    ...
    <div class="col-sm-4">
        <select readonly="" class="form-control input-sm" name="ho_perpanjangan_kode_index_lokasi" id="ho_perpanjangan_kode_index_lokasi">
            ...
            <?php if($index_lokasi): foreach($index_lokasi as $r_index_lokasi): ?>
                <option <?php echo ($fo->ho_perpanjangan_kode_index_lokasi == $r_index_lokasi->kode_index_lokasi) ? 'selected=""' : '' ?> value="<?php echo $r_index_lokasi->kode_index_lokasi ?>" nilai_index_lokasi="<?php echo $r_index_lokasi->nilai_index_lokasi ?>"><?php echo $r_index_lokasi->nama_index_lokasi ?></option>
            <?php endforeach; endif; ?>
        </select>
    </div>
    ...
    <div class="col-sm-4">
        <select readonly="" class="form-control input-sm" name="ho_perpanjangan_kode_index_harga_dasar" id="ho_perpanjangan_kode_index_harga_dasar">
            ...
            <?php if($index_harga_dasar): foreach($index_harga_dasar as $r_index_harga_dasar): ?>
                <option <?php echo ($fo->ho_perpanjangan_kode_index_harga_dasar == $r_index_harga_dasar->kode_index_harga_dasar) ? 'selected=""' : '' ?> value="<?php echo $r_index_harga_dasar->kode_index_harga_dasar ?>" nilai_index_harga_dasar="<?php echo $r_index_harga_dasar->nilai_index_harga_dasar ?>"><?php echo $r_index_harga_dasar->nama_index_harga_dasar ?></option>
            <?php endforeach; endif; ?>
        </select>
    </div>
...
<div class="form-group">
    ...
    <div class="col-sm-4">
        <input readonly="" value="<?php echo $fo->ho_perpanjangan_nilai_retribusi ?>" type="text" class="form-control input-sm" name="ho_perpanjangan_nilai_retribusi" class="ho_perpanjangan_nilai_retribusi" id="ho_perpanjangan_nilai_retribusi">
    </div>
</div>


<!-- element input hidden untuk data yang akan di simpan ke t_ho -->
<input value="<?php echo $fo->ho_perpanjangan_tinggi_tower ?>" type="hidden" name="tinggi_tower" id="tinggi_tower" >
<input value="<?php echo $fo->ho_perpanjangan_ket_luas_tempat_usaha ?>" type="hidden" name="ket_luas_tempat_usaha" id="ket_luas_tempat_usaha" >
<input value="<?php echo $fo->ho_perpanjangan_panjang_tempat_usaha ?>" type="hidden" name="panjang_tempat_usaha" id="panjang_tempat_usaha" >
<input value="<?php echo $fo->ho_perpanjangan_lebar_tempat_usaha ?>" type="hidden" name="lebar_tempat_usaha" id="lebar_tempat_usaha" >
<input value="<?php echo $fo->ho_perpanjangan_kode_index_luas ?>" type="hidden" name="kode_index_luas" id="kode_index_luas">
<input value="<?php echo $fo->ho_perpanjangan_kode_index_gangguan ?>" type="hidden" name="kode_index_gangguan" id="kode_index_gangguan">
<input value="<?php echo $fo->ho_perpanjangan_kode_index_lokasi ?>" type="hidden" name="kode_index_lokasi" id="kode_index_lokasi">
<input value="<?php echo $fo->ho_perpanjangan_kode_index_harga_dasar ?>" type="hidden" name="kode_index_harga_dasar" id="kode_index_harga_dasar">
<input value="<?php echo $fo->ho_perpanjangan_nilai_retribusi ?>" type="hidden" name="nilai_retribusi" id="nilai_retribusi">
<!-- ########################################################### -->
...
<input type="hidden" name="kode_index_luas" id="kode_index_luas" value="<?php echo $fo->ho_perpanjangan_kode_index_luas ?>">
<input type="hidden" name="kode_index_gangguan" id="kode_index_gangguan" value="<?php echo $fo->ho_perpanjangan_kode_index_gangguan ?>">
<input type="hidden" name="kode_index_lokasi" id="kode_index_lokasi" value="<?php echo $fo->ho_perpanjangan_kode_index_lokasi ?>">
<input type="hidden" name="kode_index_harga_dasar" id="kode_index_harga_dasar" value="<?php echo $fo->ho_perpanjangan_kode_index_harga_dasar ?>">

<input type="hidden" name="nilai_retribusi" id="nilai_retribusi" value="<?php echo $fo->ho_perpanjangan_nilai_retribusi ?>">
