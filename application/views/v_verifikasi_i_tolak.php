                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <ul class="nav nav-tabs">
                            <li><a href="<?php echo site_url('c_verifikasi_i/belum'); ?>">Belum</a></li>
                            <li class="active"><a href="<?php echo site_url('c_verifikasi_i/tolak'); ?>">Tolak</a></li>
                        ...
                        <table class="table table-striped table-condensed datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $r_tolak->pesan_tolak_v_i; ?></td>
                                </tr>
