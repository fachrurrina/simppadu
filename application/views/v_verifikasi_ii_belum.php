                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="<?php echo site_url('c_verifikasi_ii/belum'); ?>">Belum</a></li>
                            <li><a href="<?php echo site_url('c_verifikasi_ii/sudah'); ?>">Sudah</a></li>
                        </ul>
                    </div>
                                ...
                                <tr>
                                    <td>
                                        <form action="" method="post">
                                            ...
                                            <a href="<?php echo site_url('c_verifikasi_ii/verifikasi/'. $r_belum->no_daftar); ?>" class="btn btn-primary btn-xs">Verifikasi</a>
